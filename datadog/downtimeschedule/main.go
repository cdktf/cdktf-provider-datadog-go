...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "displayTimezone", GoGetter: "DisplayTimezone"},
			_jsii_.MemberProperty{JsiiProperty: "displayTimezoneInput", GoGetter: "DisplayTimezoneInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "monitorIdentifier", GoGetter: "MonitorIdentifier"},
			_jsii_.MemberProperty{JsiiProperty: "monitorIdentifierInput", GoGetter: "MonitorIdentifierInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "notifyEndStates", GoGetter: "NotifyEndStates"},
			_jsii_.MemberProperty{JsiiProperty: "notifyEndStatesInput", GoGetter: "NotifyEndStatesInput"},
			_jsii_.MemberProperty{JsiiProperty: "notifyEndTypes", GoGetter: "NotifyEndTypes"},
			_jsii_.MemberProperty{JsiiProperty: "notifyEndTypesInput", GoGetter: "NotifyEndTypesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putMonitorIdentifier", GoMethod: "PutMonitorIdentifier"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDisplayTimezone", GoMethod: "ResetDisplayTimezone"},
			_jsii_.MemberMethod{JsiiMethod: "resetMessage", GoMethod: "ResetMessage"},
			_jsii_.MemberMethod{JsiiMethod: "resetMonitorIdentifier", GoMethod: "ResetMonitorIdentifier"},
			_jsii_.MemberMethod{JsiiMethod: "resetMuteFirstRecoveryNotification", GoMethod: "ResetMuteFirstRecoveryNotification"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotifyEndStates", GoMethod: "ResetNotifyEndStates"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotifyEndTypes", GoMethod: "ResetNotifyEndTypes"},
