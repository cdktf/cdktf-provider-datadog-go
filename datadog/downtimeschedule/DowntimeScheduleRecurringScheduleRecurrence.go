...
type DowntimeScheduleRecurringScheduleRecurrence struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.72.0/docs/resources/downtime_schedule#duration DowntimeSchedule#duration}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.72.0/docs/resources/downtime_schedule#rrule DowntimeSchedule#rrule}
