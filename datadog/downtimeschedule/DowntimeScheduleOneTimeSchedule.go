...
type DowntimeScheduleOneTimeSchedule struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/downtime_schedule#end DowntimeSchedule#end}
