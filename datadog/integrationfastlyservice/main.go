...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IntegrationFastlyService)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.integrationFastlyService.IntegrationFastlyServiceConfig",
		reflect.TypeOf((*IntegrationFastlyServiceConfig)(nil)).Elem(),
	)
}
