...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "exclusionFilterInput", GoGetter: "ExclusionFilterInput"},
			_jsii_.MemberProperty{JsiiProperty: "filteredDataType", GoGetter: "FilteredDataType"},
			_jsii_.MemberProperty{JsiiProperty: "filteredDataTypeInput", GoGetter: "FilteredDataTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFilteredDataType", GoMethod: "ResetFilteredDataType"},
