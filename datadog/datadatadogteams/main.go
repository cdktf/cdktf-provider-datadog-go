...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "filterMe", GoGetter: "FilterMe"},
			_jsii_.MemberProperty{JsiiProperty: "filterMeInput", GoGetter: "FilterMeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFilterMe", GoMethod: "ResetFilterMe"},
