...
func (p *jsiiProxy_PowerpackWidgetQueryValueDefinitionRequestFormulaStyleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetQueryValueDefinitionRequestFormulaStyleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
