...
type PowerpackWidgetScatterplotDefinitionRequest struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.54.0/docs/resources/powerpack#scatterplot_table Powerpack#scatterplot_table}
