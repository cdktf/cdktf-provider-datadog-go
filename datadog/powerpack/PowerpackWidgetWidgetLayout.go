...
type PowerpackWidgetWidgetLayout struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.66.0/docs/resources/powerpack#is_column_break Powerpack#is_column_break}
