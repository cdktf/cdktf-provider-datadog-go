...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList) InternalValue() interface{} {
...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList)SetWrapsSet(val *bool) {
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList) Get(index *float64) PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeOutputReference {
	if err := p.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeOutputReference
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (p *jsiiProxy_PowerpackWidgetSunburstDefinitionRequestQueryEventQueryComputeList) ToString() *string {
	var returns *string
