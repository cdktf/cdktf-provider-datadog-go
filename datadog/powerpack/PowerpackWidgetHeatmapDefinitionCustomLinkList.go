...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList) InternalValue() interface{} {
...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList)SetWrapsSet(val *bool) {
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList) Get(index *float64) PowerpackWidgetHeatmapDefinitionCustomLinkOutputReference {
	if err := p.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns PowerpackWidgetHeatmapDefinitionCustomLinkOutputReference
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionCustomLinkList) ToString() *string {
	var returns *string
