...
type PowerpackWidgetQueryValueDefinitionRequestLogQuery struct {
	...
	ComputeQuery *PowerpackWidgetQueryValueDefinitionRequestLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
