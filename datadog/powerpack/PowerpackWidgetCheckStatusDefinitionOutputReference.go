...
func (p *jsiiProxy_PowerpackWidgetCheckStatusDefinitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetCheckStatusDefinitionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
