...
func (p *jsiiProxy_PowerpackWidgetListStreamDefinitionRequestQueryOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetListStreamDefinitionRequestQueryOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
