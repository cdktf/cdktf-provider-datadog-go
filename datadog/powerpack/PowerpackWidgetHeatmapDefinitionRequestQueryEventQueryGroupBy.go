...
type PowerpackWidgetHeatmapDefinitionRequestQueryEventQueryGroupBy struct {
	// The event facet.
	//
	...
	Sort *PowerpackWidgetHeatmapDefinitionRequestQueryEventQueryGroupBySort `field:"optional" json:"sort" yaml:"sort"`
}
