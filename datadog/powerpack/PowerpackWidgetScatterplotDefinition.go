...
type PowerpackWidgetScatterplotDefinition struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.61.0/docs/resources/powerpack#color_by_groups Powerpack#color_by_groups}
