...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewPowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeList {
	_init_.Initialize()
...
func NewPowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeList_Override(p PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PowerpackWidgetHeatmapDefinitionRequestLogQueryMultiComputeList) Resolve(_context cdktf.IResolveContext) interface{} {
