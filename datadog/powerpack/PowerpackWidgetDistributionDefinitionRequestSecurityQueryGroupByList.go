...
func (p *jsiiProxy_PowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PowerpackWidgetDistributionDefinitionRequestSecurityQueryGroupByList) Resolve(context cdktf.IResolveContext) interface{} {
