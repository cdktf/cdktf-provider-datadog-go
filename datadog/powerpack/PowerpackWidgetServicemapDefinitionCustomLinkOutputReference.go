...
func (p *jsiiProxy_PowerpackWidgetServicemapDefinitionCustomLinkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetServicemapDefinitionCustomLinkOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
