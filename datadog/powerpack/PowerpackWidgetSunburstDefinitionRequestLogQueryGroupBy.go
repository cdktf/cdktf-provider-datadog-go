...
type PowerpackWidgetSunburstDefinitionRequestLogQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *PowerpackWidgetSunburstDefinitionRequestLogQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
