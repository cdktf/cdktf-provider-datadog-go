...
func (p *jsiiProxy_PowerpackWidgetQueryTableDefinitionRequestApmQueryOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetQueryTableDefinitionRequestApmQueryOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
