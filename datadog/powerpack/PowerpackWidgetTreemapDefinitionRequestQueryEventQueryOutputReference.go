...
func (p *jsiiProxy_PowerpackWidgetTreemapDefinitionRequestQueryEventQueryOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetTreemapDefinitionRequestQueryEventQueryOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
