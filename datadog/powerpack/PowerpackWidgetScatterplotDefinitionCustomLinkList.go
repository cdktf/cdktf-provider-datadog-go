...
func (j *jsiiProxy_PowerpackWidgetScatterplotDefinitionCustomLinkList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewPowerpackWidgetScatterplotDefinitionCustomLinkList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PowerpackWidgetScatterplotDefinitionCustomLinkList {
	_init_.Initialize()
...
func NewPowerpackWidgetScatterplotDefinitionCustomLinkList_Override(p PowerpackWidgetScatterplotDefinitionCustomLinkList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_PowerpackWidgetScatterplotDefinitionCustomLinkList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_PowerpackWidgetScatterplotDefinitionCustomLinkList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PowerpackWidgetScatterplotDefinitionCustomLinkList) Resolve(_context cdktf.IResolveContext) interface{} {
