...
func (p *jsiiProxy_PowerpackWidgetQueryTableDefinitionRequestFormulaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetQueryTableDefinitionRequestFormulaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
