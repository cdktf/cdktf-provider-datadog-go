...
type PowerpackWidgetSunburstDefinition struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.35.0/docs/resources/powerpack#hide_total Powerpack#hide_total}
	HideTotal interface{} `field:"optional" json:"hideTotal" yaml:"hideTotal"`
	// legend_inline block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.35.0/docs/resources/powerpack#legend_inline Powerpack#legend_inline}
	LegendInline *PowerpackWidgetSunburstDefinitionLegendInline `field:"optional" json:"legendInline" yaml:"legendInline"`
	// legend_table block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.35.0/docs/resources/powerpack#legend_table Powerpack#legend_table}
