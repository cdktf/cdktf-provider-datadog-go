...
func (p *jsiiProxy_PowerpackWidgetQueryValueDefinitionRequestApmQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetQueryValueDefinitionRequestApmQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
