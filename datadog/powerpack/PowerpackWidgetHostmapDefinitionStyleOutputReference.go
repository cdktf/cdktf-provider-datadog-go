...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionStyleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetHostmapDefinitionStyleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
