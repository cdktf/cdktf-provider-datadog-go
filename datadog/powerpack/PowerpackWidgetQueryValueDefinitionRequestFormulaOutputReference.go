...
func (p *jsiiProxy_PowerpackWidgetQueryValueDefinitionRequestFormulaOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetQueryValueDefinitionRequestFormulaOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
