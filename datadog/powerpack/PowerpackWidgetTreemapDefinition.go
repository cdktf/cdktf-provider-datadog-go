...
type PowerpackWidgetTreemapDefinition struct {
	// custom_links block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.68.0/docs/resources/powerpack#custom_links Powerpack#custom_links}
