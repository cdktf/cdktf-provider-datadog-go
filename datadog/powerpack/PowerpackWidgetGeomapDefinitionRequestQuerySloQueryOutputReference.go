...
func (j *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQuerySloQueryOutputReference) CrossOrgUuids() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"crossOrgUuids",
...
func (j *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQuerySloQueryOutputReference) CrossOrgUuidsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"crossOrgUuidsInput",
...
func (j *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQuerySloQueryOutputReference)SetCrossOrgUuids(val *[]*string) {
...
func (p *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQuerySloQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQuerySloQueryOutputReference) ResetCrossOrgUuids() {
	_jsii_.InvokeVoid(
		p,
		"resetCrossOrgUuids",
		nil, // no parameters
...
func (p *jsiiProxy_PowerpackWidgetGeomapDefinitionRequestQuerySloQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
