...
type PowerpackWidgetHostmapDefinitionRequestFillLogQuery struct {
	...
	ComputeQuery *PowerpackWidgetHostmapDefinitionRequestFillLogQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
