...
type PowerpackWidgetScatterplotDefinitionRequestYSecurityQuery struct {
	...
	ComputeQuery *PowerpackWidgetScatterplotDefinitionRequestYSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
