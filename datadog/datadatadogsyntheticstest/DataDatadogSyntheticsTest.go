...
import (
	...
	"github.com/cdktf/cdktf-provider-datadog-go/datadog/v11/datadatadogsyntheticstest/internal"
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) Count() interface{} {
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) Node() constructs.Node {
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) Tags() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) TestId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"testId",
...
func (j *jsiiProxy_DataDatadogSyntheticsTest) TestIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"testIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.61.0/docs/data-sources/synthetics_test datadog_synthetics_test} Data Source.
...
func (j *jsiiProxy_DataDatadogSyntheticsTest)SetCount(val interface{}) {
...
// Experimental.
func DataDatadogSyntheticsTest_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataDatadogSyntheticsTest_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataDatadogSyntheticsTest_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataDatadogSyntheticsTest_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataDatadogSyntheticsTest_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-datadog.dataDatadogSyntheticsTest.DataDatadogSyntheticsTest",
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) ToHclTerraform() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) ToMetadata() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) ToString() *string {
	var returns *string
...
func (d *jsiiProxy_DataDatadogSyntheticsTest) ToTerraform() interface{} {
	var returns interface{}
