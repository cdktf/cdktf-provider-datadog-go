...
import (
	...
	"github.com/cdktf/cdktf-provider-datadog-go/datadog/v11/datadatadogipranges/internal"
...
type DataDatadogIpRanges interface {
	...
	OrchestratorIpv4() *[]*string
	OrchestratorIpv6() *[]*string
	ProcessIpv4() *[]*string
	ProcessIpv6() *[]*string
	// Experimental.
...
func (j *jsiiProxy_DataDatadogIpRanges) Count() interface{} {
...
func (j *jsiiProxy_DataDatadogIpRanges) OrchestratorIpv4() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"orchestratorIpv4",
...
func (j *jsiiProxy_DataDatadogIpRanges) OrchestratorIpv6() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"orchestratorIpv6",
...
func (j *jsiiProxy_DataDatadogIpRanges)SetCount(val interface{}) {
...
func (d *jsiiProxy_DataDatadogIpRanges) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDatadogIpRanges) ToHclTerraform() interface{} {
	var returns interface{}
