...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatadogUser)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "excludeServiceAccounts", GoGetter: "ExcludeServiceAccounts"},
			_jsii_.MemberProperty{JsiiProperty: "excludeServiceAccountsInput", GoGetter: "ExcludeServiceAccountsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "mfaEnabled", GoGetter: "MfaEnabled"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExcludeServiceAccounts", GoMethod: "ResetExcludeServiceAccounts"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataDatadogUserConfig)(nil)).Elem(),
	)
}
