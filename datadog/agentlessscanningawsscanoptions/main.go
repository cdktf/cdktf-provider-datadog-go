...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AgentlessScanningAwsScanOptions)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sensitiveData", GoGetter: "SensitiveData"},
			_jsii_.MemberProperty{JsiiProperty: "sensitiveDataInput", GoGetter: "SensitiveDataInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vulnContainersOs", GoGetter: "VulnContainersOs"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.agentlessScanningAwsScanOptions.AgentlessScanningAwsScanOptionsConfig",
		reflect.TypeOf((*AgentlessScanningAwsScanOptionsConfig)(nil)).Elem(),
	)
}
