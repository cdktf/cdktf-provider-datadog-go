...
func (j *jsiiProxy_TagPipelineRulesetRulesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_TagPipelineRulesetRulesList) InternalValue() interface{} {
...
func (j *jsiiProxy_TagPipelineRulesetRulesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_TagPipelineRulesetRulesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_TagPipelineRulesetRulesList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_TagPipelineRulesetRulesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_TagPipelineRulesetRulesList)SetWrapsSet(val *bool) {
...
func (t *jsiiProxy_TagPipelineRulesetRulesList) ComputeFqn() *string {
	var returns *string
...
func (t *jsiiProxy_TagPipelineRulesetRulesList) Get(index *float64) TagPipelineRulesetRulesOutputReference {
	if err := t.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns TagPipelineRulesetRulesOutputReference
...
func (t *jsiiProxy_TagPipelineRulesetRulesList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (t *jsiiProxy_TagPipelineRulesetRulesList) ToString() *string {
	var returns *string
