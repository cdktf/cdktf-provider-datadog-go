...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecurityMonitoringSuppression)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataExclusionQueryInput", GoGetter: "DataExclusionQueryInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDataExclusionQuery", GoMethod: "ResetDataExclusionQuery"},
			...
			_jsii_.MemberProperty{JsiiProperty: "suppressionQueryInput", GoGetter: "SuppressionQueryInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.securityMonitoringSuppression.SecurityMonitoringSuppressionConfig",
		reflect.TypeOf((*SecurityMonitoringSuppressionConfig)(nil)).Elem(),
	)
}
