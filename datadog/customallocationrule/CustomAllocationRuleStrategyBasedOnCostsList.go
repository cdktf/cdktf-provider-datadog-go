...
func (j *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList) InternalValue() interface{} {
...
func (j *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList) Get(index *float64) CustomAllocationRuleStrategyBasedOnCostsOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns CustomAllocationRuleStrategyBasedOnCostsOutputReference
...
func (c *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CustomAllocationRuleStrategyBasedOnCostsList) ToString() *string {
	var returns *string
