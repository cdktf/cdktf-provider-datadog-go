...
func (s *jsiiProxy_SpansMetricComputeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpansMetricComputeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
