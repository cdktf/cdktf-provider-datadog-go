...
func (c *jsiiProxy_CsmThreatsAgentRuleActionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CsmThreatsAgentRuleActionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
