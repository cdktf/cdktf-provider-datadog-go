...
func (j *jsiiProxy_CsmThreatsAgentRuleActionsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCsmThreatsAgentRuleActionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CsmThreatsAgentRuleActionsOutputReference {
	_init_.Initialize()
...
func NewCsmThreatsAgentRuleActionsOutputReference_Override(c CsmThreatsAgentRuleActionsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CsmThreatsAgentRuleActionsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CsmThreatsAgentRuleActionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CsmThreatsAgentRuleActionsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_CsmThreatsAgentRuleActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CsmThreatsAgentRuleActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
