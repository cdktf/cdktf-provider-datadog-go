...
import (
	...
	"github.com/hashicorp/cdktf-provider-datadog-go/datadog/v3/user/internal"
...
type User interface {
	...
	SetSendUserInvitation(val interface{})
	SendUserInvitationInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_User) Roles() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"roles",
...
func (j *jsiiProxy_User) RolesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"rolesInput",
...
func (j *jsiiProxy_User) SendUserInvitation() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"sendUserInvitation",
...
func (j *jsiiProxy_User) SendUserInvitationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_User) UserInvitationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"userInvitationId",
...
func (j *jsiiProxy_User) Verified() cdktf.IResolvable {
...
func (j *jsiiProxy_User)SetRoles(val *[]*string) {
...
func (j *jsiiProxy_User)SetSendUserInvitation(val interface{}) {
	if err := j.validateSetSendUserInvitationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (u *jsiiProxy_User) ResetName() {
	_jsii_.InvokeVoid(
		u,
		"resetName",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetRoles() {
	_jsii_.InvokeVoid(
		u,
		"resetRoles",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetSendUserInvitation() {
	_jsii_.InvokeVoid(
		u,
		"resetSendUserInvitation",
		nil, // no parameters
