...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSendUserInvitation", GoMethod: "ResetSendUserInvitation"},
			_jsii_.MemberProperty{JsiiProperty: "roles", GoGetter: "Roles"},
			_jsii_.MemberProperty{JsiiProperty: "rolesInput", GoGetter: "RolesInput"},
			_jsii_.MemberProperty{JsiiProperty: "sendUserInvitation", GoGetter: "SendUserInvitation"},
			_jsii_.MemberProperty{JsiiProperty: "sendUserInvitationInput", GoGetter: "SendUserInvitationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "userInvitationId", GoGetter: "UserInvitationId"},
