...
import (
	...
	"github.com/cdktf/cdktf-provider-datadog-go/datadog/v11/webhook/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.63.0/docs/resources/webhook datadog_webhook}.
type Webhook interface {
	...
	EncodeAs() *string
	SetEncodeAs(val *string)
	EncodeAsInput() *string
	// Experimental.
...
// The jsii proxy struct for Webhook
type jsiiProxy_Webhook struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_Webhook) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_Webhook) Connection() interface{} {
...
func (j *jsiiProxy_Webhook) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_Webhook) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Webhook) CustomHeaders() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customHeaders",
...
func (j *jsiiProxy_Webhook) CustomHeadersInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customHeadersInput",
...
func (j *jsiiProxy_Webhook) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_Webhook) EncodeAs() *string {
	var returns *string
	_jsii_.Get(
		j,
		"encodeAs",
...
func (j *jsiiProxy_Webhook) EncodeAsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"encodeAsInput",
...
func (j *jsiiProxy_Webhook) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_Webhook) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_Webhook) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_Webhook) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_Webhook) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Webhook) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Webhook) Node() constructs.Node {
...
func (j *jsiiProxy_Webhook) Payload() *string {
	var returns *string
	_jsii_.Get(
		j,
		"payload",
...
func (j *jsiiProxy_Webhook) PayloadInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"payloadInput",
...
func (j *jsiiProxy_Webhook) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_Webhook) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_Webhook) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_Webhook) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Webhook) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Webhook) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Webhook) Url() *string {
	var returns *string
	_jsii_.Get(
		j,
		"url",
...
func (j *jsiiProxy_Webhook) UrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"urlInput",
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.63.0/docs/resources/webhook datadog_webhook} Resource.
...
func (j *jsiiProxy_Webhook)SetCount(val interface{}) {
...
func Webhook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWebhook_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_Webhook) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_Webhook) ResetCustomHeaders() {
	_jsii_.InvokeVoid(
		w,
		"resetCustomHeaders",
		nil, // no parameters
...
func (w *jsiiProxy_Webhook) ResetEncodeAs() {
	_jsii_.InvokeVoid(
		w,
		"resetEncodeAs",
		nil, // no parameters
...
func (w *jsiiProxy_Webhook) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		w,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (w *jsiiProxy_Webhook) ResetPayload() {
	_jsii_.InvokeVoid(
		w,
		"resetPayload",
		nil, // no parameters
...
func (w *jsiiProxy_Webhook) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_Webhook) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_Webhook) ToHclTerraform() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_Webhook) ToMetadata() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_Webhook) ToString() *string {
	var returns *string
...
func (w *jsiiProxy_Webhook) ToTerraform() interface{} {
	var returns interface{}
