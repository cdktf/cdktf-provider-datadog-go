...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "encodeAs", GoGetter: "EncodeAs"},
			_jsii_.MemberProperty{JsiiProperty: "encodeAsInput", GoGetter: "EncodeAsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEncodeAs", GoMethod: "ResetEncodeAs"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*WebhookConfig)(nil)).Elem(),
	)
}
