...
type SyntheticsTestAssertion struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/synthetics_test#operator SyntheticsTest#operator}
	Operator *string `field:"optional" json:"operator" yaml:"operator"`
	// If assertion type is `header`, this is the header name.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/synthetics_test#property SyntheticsTest#property}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/synthetics_test#target SyntheticsTest#target}
	Target *string `field:"optional" json:"target" yaml:"target"`
	// targetjsonpath block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/synthetics_test#targetjsonpath SyntheticsTest#targetjsonpath}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/synthetics_test#targetjsonschema SyntheticsTest#targetjsonschema}
	Targetjsonschema *SyntheticsTestAssertionTargetjsonschema `field:"optional" json:"targetjsonschema" yaml:"targetjsonschema"`
	// targetxpath block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/synthetics_test#targetxpath SyntheticsTest#targetxpath}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/synthetics_test#timings_scope SyntheticsTest#timings_scope}
