...
func (s *jsiiProxy_SyntheticsTestMobileStepParamsElementUserLocatorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestMobileStepParamsElementUserLocatorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
