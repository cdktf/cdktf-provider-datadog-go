...
type SyntheticsTestMobileStepParamsElementUserLocator struct {
	...
	// values block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.78.0/docs/resources/synthetics_test#values SyntheticsTest#values}
