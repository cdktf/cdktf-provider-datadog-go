...
type SyntheticsTestApiStepAssertionTargetxpath struct {
	...
	// The xpath to assert.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.69.0/docs/resources/synthetics_test#xpath SyntheticsTest#xpath}
