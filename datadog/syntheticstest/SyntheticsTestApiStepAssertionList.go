...
type SyntheticsTestApiStepAssertionList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) SyntheticsTestApiStepAssertionOutputReference
...
// The jsii proxy struct for SyntheticsTestApiStepAssertionList
type jsiiProxy_SyntheticsTestApiStepAssertionList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_SyntheticsTestApiStepAssertionList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionList) InternalValue() interface{} {
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_SyntheticsTestApiStepAssertionList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SyntheticsTestApiStepAssertionList) ToString() *string {
	var returns *string
