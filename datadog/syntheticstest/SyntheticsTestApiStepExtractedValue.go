...
type SyntheticsTestApiStepExtractedValue struct {
	...
	// parser block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.53.0/docs/resources/synthetics_test#parser SyntheticsTest#parser}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.53.0/docs/resources/synthetics_test#field SyntheticsTest#field}
	Field *string `field:"optional" json:"field" yaml:"field"`
	// Determines whether or not the extracted value will be obfuscated.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.53.0/docs/resources/synthetics_test#secure SyntheticsTest#secure}
