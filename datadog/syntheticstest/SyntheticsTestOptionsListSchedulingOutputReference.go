...
func (s *jsiiProxy_SyntheticsTestOptionsListSchedulingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestOptionsListSchedulingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
