...
type SyntheticsTestBrowserStepParams struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#append_to_content SyntheticsTest#append_to_content}
	AppendToContent interface{} `field:"optional" json:"appendToContent" yaml:"appendToContent"`
	// Name of the attribute to use for an "assert attribute" step.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#attribute SyntheticsTest#attribute}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#click_type SyntheticsTest#click_type}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#click_with_javascript SyntheticsTest#click_with_javascript}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#code SyntheticsTest#code}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#element_user_locator SyntheticsTest#element_user_locator}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#email SyntheticsTest#email}
	Email *string `field:"optional" json:"email" yaml:"email"`
	// JSON encoded string used for an "assert download" step.
	//
	// Refer to the examples for a usage example showing the schema.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#file SyntheticsTest#file}
	File *string `field:"optional" json:"file" yaml:"file"`
	// Details of the files for an "upload files" step, JSON encoded string.
	//
	// Refer to the examples for a usage example showing the schema.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#files SyntheticsTest#files}
	Files *string `field:"optional" json:"files" yaml:"files"`
	// Modifier to use for a "press key" step.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#modifiers SyntheticsTest#modifiers}
	Modifiers *[]*string `field:"optional" json:"modifiers" yaml:"modifiers"`
	// pattern block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#pattern SyntheticsTest#pattern}
	Pattern *SyntheticsTestBrowserStepParamsPattern `field:"optional" json:"pattern" yaml:"pattern"`
	// ID of the tab to play the subtest.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#playing_tab_id SyntheticsTest#playing_tab_id}
	PlayingTabId *string `field:"optional" json:"playingTabId" yaml:"playingTabId"`
	// Request for an API step.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#request SyntheticsTest#request}
	...
	// Refer to the examples for a usage example showing the schema.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#requests SyntheticsTest#requests}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.77.0/docs/resources/synthetics_test#with_click SyntheticsTest#with_click}
