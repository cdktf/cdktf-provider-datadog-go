...
func NewSyntheticsTestBrowserStepParamsElementUserLocatorValueOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SyntheticsTestBrowserStepParamsElementUserLocatorValueOutputReference {
	...
	if err := validateNewSyntheticsTestBrowserStepParamsElementUserLocatorValueOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SyntheticsTestBrowserStepParamsElementUserLocatorValueOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestBrowserStepParamsElementUserLocatorValueOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
