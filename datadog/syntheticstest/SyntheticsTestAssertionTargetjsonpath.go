...
type SyntheticsTestAssertionTargetjsonpath struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.69.0/docs/resources/synthetics_test#jsonpath SyntheticsTest#jsonpath}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.69.0/docs/resources/synthetics_test#elementsoperator SyntheticsTest#elementsoperator}
	Elementsoperator *string `field:"optional" json:"elementsoperator" yaml:"elementsoperator"`
	// Expected matching value.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.69.0/docs/resources/synthetics_test#targetvalue SyntheticsTest#targetvalue}
