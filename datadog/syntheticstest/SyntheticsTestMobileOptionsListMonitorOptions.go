...
type SyntheticsTestMobileOptionsListMonitorOptions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.61.0/docs/resources/synthetics_test#notification_preset_name SyntheticsTest#notification_preset_name}
