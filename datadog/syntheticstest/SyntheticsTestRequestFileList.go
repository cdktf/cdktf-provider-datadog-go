...
func (j *jsiiProxy_SyntheticsTestRequestFileList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SyntheticsTestRequestFileList) InternalValue() interface{} {
...
func (j *jsiiProxy_SyntheticsTestRequestFileList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SyntheticsTestRequestFileList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_SyntheticsTestRequestFileList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_SyntheticsTestRequestFileList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_SyntheticsTestRequestFileList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_SyntheticsTestRequestFileList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SyntheticsTestRequestFileList) Get(index *float64) SyntheticsTestRequestFileOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns SyntheticsTestRequestFileOutputReference
...
func (s *jsiiProxy_SyntheticsTestRequestFileList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SyntheticsTestRequestFileList) ToString() *string {
	var returns *string
