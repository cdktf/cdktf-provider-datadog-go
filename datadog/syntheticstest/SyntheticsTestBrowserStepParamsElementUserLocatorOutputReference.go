...
func (s *jsiiProxy_SyntheticsTestBrowserStepParamsElementUserLocatorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsTestBrowserStepParamsElementUserLocatorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
