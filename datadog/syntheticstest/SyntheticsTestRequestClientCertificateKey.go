...
type SyntheticsTestRequestClientCertificateKey struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/synthetics_test#filename SyntheticsTest#filename}
