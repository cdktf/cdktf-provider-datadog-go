...
func (j *jsiiProxy_MetricMetadata) Connection() interface{} {
...
func (j *jsiiProxy_MetricMetadata) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_MetricMetadata) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_MetricMetadata) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_MetricMetadata) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_MetricMetadata) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MetricMetadata) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_MetricMetadata) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_MetricMetadata) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MetricMetadata) Metric() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metric",
...
func (j *jsiiProxy_MetricMetadata) MetricInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"metricInput",
...
func (j *jsiiProxy_MetricMetadata) Node() constructs.Node {
...
func (j *jsiiProxy_MetricMetadata) PerUnit() *string {
	var returns *string
	_jsii_.Get(
		j,
		"perUnit",
...
func (j *jsiiProxy_MetricMetadata) PerUnitInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"perUnitInput",
...
func (j *jsiiProxy_MetricMetadata) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_MetricMetadata) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_MetricMetadata) ShortName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"shortName",
...
func (j *jsiiProxy_MetricMetadata) ShortNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"shortNameInput",
...
func (j *jsiiProxy_MetricMetadata) StatsdInterval() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"statsdInterval",
...
func (j *jsiiProxy_MetricMetadata) StatsdIntervalInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"statsdIntervalInput",
...
func (j *jsiiProxy_MetricMetadata) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MetricMetadata) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MetricMetadata) Type() *string {
	var returns *string
	_jsii_.Get(
		j,
		"type",
...
func (j *jsiiProxy_MetricMetadata) TypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"typeInput",
...
func (j *jsiiProxy_MetricMetadata) Unit() *string {
	var returns *string
	_jsii_.Get(
		j,
		"unit",
...
func (j *jsiiProxy_MetricMetadata) UnitInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"unitInput",
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.70.0/docs/resources/metric_metadata datadog_metric_metadata} Resource.
...
// Experimental.
func MetricMetadata_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMetricMetadata_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MetricMetadata_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMetricMetadata_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MetricMetadata_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-datadog.metricMetadata.MetricMetadata",
...
func (m *jsiiProxy_MetricMetadata) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MetricMetadata) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MetricMetadata) MoveFromId(id *string) {
...
func (m *jsiiProxy_MetricMetadata) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MetricMetadata) MoveToId(id *string) {
...
func (m *jsiiProxy_MetricMetadata) ResetDescription() {
	_jsii_.InvokeVoid(
		m,
		"resetDescription",
		nil, // no parameters
...
func (m *jsiiProxy_MetricMetadata) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MetricMetadata) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		m,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (m *jsiiProxy_MetricMetadata) ResetPerUnit() {
	_jsii_.InvokeVoid(
		m,
		"resetPerUnit",
		nil, // no parameters
...
func (m *jsiiProxy_MetricMetadata) ResetShortName() {
	_jsii_.InvokeVoid(
		m,
		"resetShortName",
		nil, // no parameters
...
func (m *jsiiProxy_MetricMetadata) ResetStatsdInterval() {
	_jsii_.InvokeVoid(
		m,
		"resetStatsdInterval",
		nil, // no parameters
...
func (m *jsiiProxy_MetricMetadata) ResetType() {
	_jsii_.InvokeVoid(
		m,
		"resetType",
		nil, // no parameters
...
func (m *jsiiProxy_MetricMetadata) ResetUnit() {
	_jsii_.InvokeVoid(
		m,
		"resetUnit",
		nil, // no parameters
...
func (m *jsiiProxy_MetricMetadata) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MetricMetadata) ToMetadata() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MetricMetadata) ToString() *string {
	var returns *string
...
func (m *jsiiProxy_MetricMetadata) ToTerraform() interface{} {
	var returns interface{}
