...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MetricMetadata)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "perUnit", GoGetter: "PerUnit"},
			_jsii_.MemberProperty{JsiiProperty: "perUnitInput", GoGetter: "PerUnitInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPerUnit", GoMethod: "ResetPerUnit"},
			_jsii_.MemberMethod{JsiiMethod: "resetShortName", GoMethod: "ResetShortName"},
			_jsii_.MemberMethod{JsiiMethod: "resetStatsdInterval", GoMethod: "ResetStatsdInterval"},
			...
			_jsii_.MemberProperty{JsiiProperty: "statsdInterval", GoGetter: "StatsdInterval"},
			_jsii_.MemberProperty{JsiiProperty: "statsdIntervalInput", GoGetter: "StatsdIntervalInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*MetricMetadataConfig)(nil)).Elem(),
	)
}
