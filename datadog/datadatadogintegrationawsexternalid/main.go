...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatadogIntegrationAwsExternalId)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.dataDatadogIntegrationAwsExternalId.DataDatadogIntegrationAwsExternalIdConfig",
		reflect.TypeOf((*DataDatadogIntegrationAwsExternalIdConfig)(nil)).Elem(),
	)
}
