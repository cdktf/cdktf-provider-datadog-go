...
// The jsii proxy struct for ServiceLevelObjectiveThresholdsList
type jsiiProxy_ServiceLevelObjectiveThresholdsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ServiceLevelObjectiveThresholdsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ServiceLevelObjectiveThresholdsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ServiceLevelObjectiveThresholdsList) InternalValue() interface{} {
...
func (j *jsiiProxy_ServiceLevelObjectiveThresholdsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ServiceLevelObjectiveThresholdsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ServiceLevelObjectiveThresholdsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (s *jsiiProxy_ServiceLevelObjectiveThresholdsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServiceLevelObjectiveThresholdsList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_ServiceLevelObjectiveThresholdsList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_ServiceLevelObjectiveThresholdsList) ToString() *string {
	var returns *string
