...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "relatedResourceTypes", GoGetter: "RelatedResourceTypes"},
			_jsii_.MemberProperty{JsiiProperty: "relatedResourceTypesInput", GoGetter: "RelatedResourceTypesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRelatedResourceTypes", GoMethod: "ResetRelatedResourceTypes"},
