...
func (d *jsiiProxy_DashboardWidgetToplistDefinitionRequestSecurityQueryGroupByList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DashboardWidgetToplistDefinitionRequestSecurityQueryGroupByList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
