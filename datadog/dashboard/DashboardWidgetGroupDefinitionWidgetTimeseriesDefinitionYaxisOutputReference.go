...
func NewDashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisOutputReference {
	...
	if err := validateNewDashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionYaxisOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
