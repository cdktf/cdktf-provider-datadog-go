...
func (d *jsiiProxy_DashboardWidgetScatterplotDefinitionRequestScatterplotTableFormulaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetScatterplotDefinitionRequestScatterplotTableFormulaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
