...
func (d *jsiiProxy_DashboardWidgetPowerpackDefinitionTemplateVariablesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetPowerpackDefinitionTemplateVariablesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
