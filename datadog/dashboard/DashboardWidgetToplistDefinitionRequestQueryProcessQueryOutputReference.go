...
func (j *jsiiProxy_DashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReference) CrossOrgUuids() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"crossOrgUuids",
...
func (j *jsiiProxy_DashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReference) CrossOrgUuidsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"crossOrgUuidsInput",
...
func NewDashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReference {
	...
	if err := validateNewDashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReference)SetCrossOrgUuids(val *[]*string) {
...
func (d *jsiiProxy_DashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReference) ResetCrossOrgUuids() {
	_jsii_.InvokeVoid(
		d,
		"resetCrossOrgUuids",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetToplistDefinitionRequestQueryProcessQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
