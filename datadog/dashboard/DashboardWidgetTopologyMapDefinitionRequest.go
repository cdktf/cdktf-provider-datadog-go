...
type DashboardWidgetTopologyMapDefinitionRequest struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/dashboard#request_type Dashboard#request_type}
