...
type DashboardWidgetTraceServiceDefinition struct {
	...
	// APM span name.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.60.0/docs/resources/dashboard#span_name Dashboard#span_name}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.60.0/docs/resources/dashboard#show_breakdown Dashboard#show_breakdown}
	ShowBreakdown interface{} `field:"optional" json:"showBreakdown" yaml:"showBreakdown"`
	// Whether to show the latency distribution or not.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.60.0/docs/resources/dashboard#show_distribution Dashboard#show_distribution}
	ShowDistribution interface{} `field:"optional" json:"showDistribution" yaml:"showDistribution"`
	// Whether to show the error metrics or not.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.60.0/docs/resources/dashboard#show_errors Dashboard#show_errors}
	ShowErrors interface{} `field:"optional" json:"showErrors" yaml:"showErrors"`
	// Whether to show the hits metrics or not.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.60.0/docs/resources/dashboard#show_hits Dashboard#show_hits}
	ShowHits interface{} `field:"optional" json:"showHits" yaml:"showHits"`
	// Whether to show the latency metrics or not.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.60.0/docs/resources/dashboard#show_latency Dashboard#show_latency}
	ShowLatency interface{} `field:"optional" json:"showLatency" yaml:"showLatency"`
	// Whether to show the resource list or not.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.60.0/docs/resources/dashboard#show_resource_list Dashboard#show_resource_list}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.60.0/docs/resources/dashboard#size_format Dashboard#size_format}
