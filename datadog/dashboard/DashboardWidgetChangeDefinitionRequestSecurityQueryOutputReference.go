...
func NewDashboardWidgetChangeDefinitionRequestSecurityQueryOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DashboardWidgetChangeDefinitionRequestSecurityQueryOutputReference {
	...
	if err := validateNewDashboardWidgetChangeDefinitionRequestSecurityQueryOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetChangeDefinitionRequestSecurityQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetChangeDefinitionRequestSecurityQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
