...
type DashboardWidgetHostmapDefinitionRequestSizeSecurityQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardWidgetHostmapDefinitionRequestSizeSecurityQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
