...
type DashboardWidgetTimeseriesDefinitionRequestSecurityQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardWidgetTimeseriesDefinitionRequestSecurityQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
