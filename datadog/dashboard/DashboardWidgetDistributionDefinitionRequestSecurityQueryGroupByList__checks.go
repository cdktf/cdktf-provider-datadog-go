...
func (d *jsiiProxy_DashboardWidgetDistributionDefinitionRequestSecurityQueryGroupByList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DashboardWidgetDistributionDefinitionRequestSecurityQueryGroupByList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
