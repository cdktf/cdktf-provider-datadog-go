...
func NewDashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestApmQueryMultiComputeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestApmQueryMultiComputeList {
	...
	if err := validateNewDashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestApmQueryMultiComputeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestApmQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestApmQueryMultiComputeList) Resolve(context cdktf.IResolveContext) interface{} {
