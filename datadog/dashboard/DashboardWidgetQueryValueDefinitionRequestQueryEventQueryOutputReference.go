...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) CrossOrgUuids() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"crossOrgUuids",
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) CrossOrgUuidsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"crossOrgUuidsInput",
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) Storage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storage",
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) StorageInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageInput",
...
func NewDashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference {
	...
	if err := validateNewDashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference)SetCrossOrgUuids(val *[]*string) {
...
func (j *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference)SetStorage(val *string) {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) ResetCrossOrgUuids() {
	_jsii_.InvokeVoid(
		d,
		"resetCrossOrgUuids",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) ResetStorage() {
	_jsii_.InvokeVoid(
		d,
		"resetStorage",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestQueryEventQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
