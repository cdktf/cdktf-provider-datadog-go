...
type DashboardWidgetSunburstDefinitionRequestLogQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardWidgetSunburstDefinitionRequestLogQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
