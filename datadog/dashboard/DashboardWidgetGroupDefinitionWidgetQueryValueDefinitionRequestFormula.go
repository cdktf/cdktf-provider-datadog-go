...
type DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestFormula struct {
	...
	Limit *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
