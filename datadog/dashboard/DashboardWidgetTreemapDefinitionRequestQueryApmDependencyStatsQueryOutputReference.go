...
func (j *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryOutputReference) CrossOrgUuids() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"crossOrgUuids",
...
func (j *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryOutputReference) CrossOrgUuidsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"crossOrgUuidsInput",
...
func (j *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryOutputReference)SetCrossOrgUuids(val *[]*string) {
...
func (d *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryOutputReference) ResetCrossOrgUuids() {
	_jsii_.InvokeVoid(
		d,
		"resetCrossOrgUuids",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetTreemapDefinitionRequestQueryApmDependencyStatsQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
