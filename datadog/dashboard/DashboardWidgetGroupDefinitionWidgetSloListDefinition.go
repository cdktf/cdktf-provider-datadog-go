...
type DashboardWidgetGroupDefinitionWidgetSloListDefinition struct {
	// request block.
	//
	...
	Request *DashboardWidgetGroupDefinitionWidgetSloListDefinitionRequest `field:"required" json:"request" yaml:"request"`
