...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestAuditQueryMultiComputeList) Resolve(context cdktf.IResolveContext) interface{} {
