...
func NewDashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestOutputReference {
	...
	if err := validateNewDashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
