...
type DashboardWidgetGroupDefinitionWidgetFreeTextDefinition struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.50.0/docs/resources/dashboard#text Dashboard#text}
	Text *string `field:"required" json:"text" yaml:"text"`
	// The color of the text in the widget.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.50.0/docs/resources/dashboard#color Dashboard#color}
