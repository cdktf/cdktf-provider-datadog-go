...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetSplitGraphDefinitionSourceWidgetDefinitionTimeseriesDefinitionRequestList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
