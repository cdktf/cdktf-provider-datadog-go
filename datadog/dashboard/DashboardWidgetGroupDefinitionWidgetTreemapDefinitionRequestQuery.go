...
type DashboardWidgetGroupDefinitionWidgetTreemapDefinitionRequestQuery struct {
	...
	CloudCostQuery *DashboardWidgetGroupDefinitionWidgetTreemapDefinitionRequestQueryCloudCostQuery `field:"optional" json:"cloudCostQuery" yaml:"cloudCostQuery"`
	// event_query block.
	//
	...
	SloQuery *DashboardWidgetGroupDefinitionWidgetTreemapDefinitionRequestQuerySloQuery `field:"optional" json:"sloQuery" yaml:"sloQuery"`
}
