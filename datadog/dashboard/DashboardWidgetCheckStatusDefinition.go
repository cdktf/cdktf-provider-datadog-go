...
type DashboardWidgetCheckStatusDefinition struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.48.0/docs/resources/dashboard#check Dashboard#check}
	Check *string `field:"required" json:"check" yaml:"check"`
	// The kind of grouping to use. Valid values are `check`, `cluster`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.48.0/docs/resources/dashboard#grouping Dashboard#grouping}
