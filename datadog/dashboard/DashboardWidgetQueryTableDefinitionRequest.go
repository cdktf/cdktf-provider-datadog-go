...
type DashboardWidgetQueryTableDefinitionRequest struct {
	...
	ApmQuery *DashboardWidgetQueryTableDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	...
	ApmStatsQuery *DashboardWidgetQueryTableDefinitionRequestApmStatsQuery `field:"optional" json:"apmStatsQuery" yaml:"apmStatsQuery"`
	...
	LogQuery *DashboardWidgetQueryTableDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	...
	ProcessQuery *DashboardWidgetQueryTableDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *DashboardWidgetQueryTableDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *DashboardWidgetQueryTableDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
	// text_formats block.
	//
