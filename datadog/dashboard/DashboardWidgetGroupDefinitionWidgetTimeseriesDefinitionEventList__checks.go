...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionEventList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionEventList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
