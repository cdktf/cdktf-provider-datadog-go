...
func NewDashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList {
	...
	if err := validateNewDashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetTimeseriesDefinitionRequestNetworkQueryGroupByList) Resolve(context cdktf.IResolveContext) interface{} {
