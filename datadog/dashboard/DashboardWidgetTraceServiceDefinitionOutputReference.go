...
func (d *jsiiProxy_DashboardWidgetTraceServiceDefinitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetTraceServiceDefinitionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
