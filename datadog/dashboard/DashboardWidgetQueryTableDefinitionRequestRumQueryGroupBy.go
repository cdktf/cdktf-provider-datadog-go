...
type DashboardWidgetQueryTableDefinitionRequestRumQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardWidgetQueryTableDefinitionRequestRumQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
