...
type DashboardWidgetTreemapDefinitionRequestQuery struct {
	...
	ApmDependencyStatsQuery *DashboardWidgetTreemapDefinitionRequestQueryApmDependencyStatsQuery `field:"optional" json:"apmDependencyStatsQuery" yaml:"apmDependencyStatsQuery"`
	...
	ApmResourceStatsQuery *DashboardWidgetTreemapDefinitionRequestQueryApmResourceStatsQuery `field:"optional" json:"apmResourceStatsQuery" yaml:"apmResourceStatsQuery"`
	...
	CloudCostQuery *DashboardWidgetTreemapDefinitionRequestQueryCloudCostQuery `field:"optional" json:"cloudCostQuery" yaml:"cloudCostQuery"`
	// event_query block.
	//
	...
	EventQuery *DashboardWidgetTreemapDefinitionRequestQueryEventQuery `field:"optional" json:"eventQuery" yaml:"eventQuery"`
	// metric_query block.
	//
	...
	MetricQuery *DashboardWidgetTreemapDefinitionRequestQueryMetricQuery `field:"optional" json:"metricQuery" yaml:"metricQuery"`
	// process_query block.
	//
	...
	ProcessQuery *DashboardWidgetTreemapDefinitionRequestQueryProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	// slo_query block.
	//
	...
	SloQuery *DashboardWidgetTreemapDefinitionRequestQuerySloQuery `field:"optional" json:"sloQuery" yaml:"sloQuery"`
}
