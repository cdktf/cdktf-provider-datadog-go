...
type DashboardWidgetHeatmapDefinitionRequestFormula struct {
	...
	Limit *DashboardWidgetHeatmapDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardWidgetHeatmapDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardWidgetHeatmapDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
