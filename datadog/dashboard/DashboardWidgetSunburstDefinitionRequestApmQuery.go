...
type DashboardWidgetSunburstDefinitionRequestApmQuery struct {
	...
	ComputeQuery *DashboardWidgetSunburstDefinitionRequestApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
