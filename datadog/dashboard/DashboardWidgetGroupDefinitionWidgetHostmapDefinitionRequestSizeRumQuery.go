...
type DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeRumQuery struct {
	...
	ComputeQuery *DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestSizeRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
