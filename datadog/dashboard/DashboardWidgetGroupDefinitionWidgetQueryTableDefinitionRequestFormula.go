...
type DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	NumberFormat *DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardWidgetGroupDefinitionWidgetQueryTableDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
