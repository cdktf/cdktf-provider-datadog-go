...
type DashboardWidgetSunburstDefinitionRequestRumQuery struct {
	...
	ComputeQuery *DashboardWidgetSunburstDefinitionRequestRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
