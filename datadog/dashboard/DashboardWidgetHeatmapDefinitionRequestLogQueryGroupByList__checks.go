...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestLogQueryGroupByList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionRequestLogQueryGroupByList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
