...
func (d *jsiiProxy_DashboardWidgetScatterplotDefinitionRequestYList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DashboardWidgetScatterplotDefinitionRequestYList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
