...
func (d *jsiiProxy_DashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetSunburstDefinitionRequestSecurityQueryGroupByList) Resolve(context cdktf.IResolveContext) interface{} {
