...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionEventList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DashboardWidgetHeatmapDefinitionEventList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
