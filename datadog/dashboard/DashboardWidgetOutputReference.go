...
func (d *jsiiProxy_DashboardWidgetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
