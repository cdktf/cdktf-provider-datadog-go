...
func NewDashboardWidgetGroupDefinitionWidgetScatterplotDefinitionYaxisOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionYaxisOutputReference {
	...
	if err := validateNewDashboardWidgetGroupDefinitionWidgetScatterplotDefinitionYaxisOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionYaxisOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetScatterplotDefinitionYaxisOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
