...
type DashboardWidgetChangeDefinitionRequestRumQuery struct {
	...
	ComputeQuery *DashboardWidgetChangeDefinitionRequestRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
