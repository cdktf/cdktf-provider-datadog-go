...
func NewDashboardWidgetHostmapDefinitionRequestSizeLogQueryComputeQueryOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DashboardWidgetHostmapDefinitionRequestSizeLogQueryComputeQueryOutputReference {
	...
	if err := validateNewDashboardWidgetHostmapDefinitionRequestSizeLogQueryComputeQueryOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetHostmapDefinitionRequestSizeLogQueryComputeQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetHostmapDefinitionRequestSizeLogQueryComputeQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
