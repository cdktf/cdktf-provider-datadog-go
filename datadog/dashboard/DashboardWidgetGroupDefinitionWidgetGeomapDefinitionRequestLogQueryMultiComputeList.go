...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetGeomapDefinitionRequestLogQueryMultiComputeList) Resolve(context cdktf.IResolveContext) interface{} {
