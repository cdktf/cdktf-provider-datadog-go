...
type DashboardWidgetQueryTableDefinitionRequestFormula struct {
	...
	CellDisplayModeOptions *DashboardWidgetQueryTableDefinitionRequestFormulaCellDisplayModeOptions `field:"optional" json:"cellDisplayModeOptions" yaml:"cellDisplayModeOptions"`
	...
	Limit *DashboardWidgetQueryTableDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardWidgetQueryTableDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardWidgetQueryTableDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
