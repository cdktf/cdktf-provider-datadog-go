...
func NewDashboardWidgetQueryValueDefinitionRequestLogQueryComputeQueryOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DashboardWidgetQueryValueDefinitionRequestLogQueryComputeQueryOutputReference {
	...
	if err := validateNewDashboardWidgetQueryValueDefinitionRequestLogQueryComputeQueryOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestLogQueryComputeQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetQueryValueDefinitionRequestLogQueryComputeQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
