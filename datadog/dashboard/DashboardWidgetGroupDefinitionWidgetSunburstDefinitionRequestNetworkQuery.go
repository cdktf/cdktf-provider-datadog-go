...
type DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestNetworkQuery struct {
	...
	ComputeQuery *DashboardWidgetGroupDefinitionWidgetSunburstDefinitionRequestNetworkQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
