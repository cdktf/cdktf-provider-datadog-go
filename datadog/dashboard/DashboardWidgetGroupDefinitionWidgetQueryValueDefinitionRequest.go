...
type DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequest struct {
	...
	ApmQuery *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestApmQuery `field:"optional" json:"apmQuery" yaml:"apmQuery"`
	// audit_query block.
	//
	...
	AuditQuery *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestAuditQuery `field:"optional" json:"auditQuery" yaml:"auditQuery"`
	...
	LogQuery *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestLogQuery `field:"optional" json:"logQuery" yaml:"logQuery"`
	// process_query block.
	//
	...
	ProcessQuery *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestProcessQuery `field:"optional" json:"processQuery" yaml:"processQuery"`
	...
	RumQuery *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestRumQuery `field:"optional" json:"rumQuery" yaml:"rumQuery"`
	...
	SecurityQuery *DashboardWidgetGroupDefinitionWidgetQueryValueDefinitionRequestSecurityQuery `field:"optional" json:"securityQuery" yaml:"securityQuery"`
}
