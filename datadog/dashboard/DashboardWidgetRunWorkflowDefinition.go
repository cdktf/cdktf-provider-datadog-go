...
type DashboardWidgetRunWorkflowDefinition struct {
	// Workflow ID.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.39.0/docs/resources/dashboard#workflow_id Dashboard#workflow_id}
	...
	// input block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.39.0/docs/resources/dashboard#input Dashboard#input}
