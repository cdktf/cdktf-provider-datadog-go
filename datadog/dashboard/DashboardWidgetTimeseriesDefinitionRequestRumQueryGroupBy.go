...
type DashboardWidgetTimeseriesDefinitionRequestRumQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardWidgetTimeseriesDefinitionRequestRumQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
