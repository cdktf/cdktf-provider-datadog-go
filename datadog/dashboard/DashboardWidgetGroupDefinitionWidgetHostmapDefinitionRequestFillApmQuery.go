...
type DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestFillApmQuery struct {
	...
	ComputeQuery *DashboardWidgetGroupDefinitionWidgetHostmapDefinitionRequestFillApmQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
