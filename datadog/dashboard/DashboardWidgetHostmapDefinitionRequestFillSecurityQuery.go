...
type DashboardWidgetHostmapDefinitionRequestFillSecurityQuery struct {
	...
	ComputeQuery *DashboardWidgetHostmapDefinitionRequestFillSecurityQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
