...
type DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference interface {
	...
	NumberFormat() DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaNumberFormatOutputReference
	NumberFormatInput() *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaNumberFormat
	Style() DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleOutputReference
	StyleInput() *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle
	// Experimental.
	...
	PutNumberFormat(value *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaNumberFormat)
	PutStyle(value *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle)
	ResetAlias()
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) NumberFormat() DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaNumberFormatOutputReference {
	var returns DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaNumberFormatOutputReference
	_jsii_.Get(
		j,
		"numberFormat",
		&returns,
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) NumberFormatInput() *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaNumberFormat {
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) Style() DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleOutputReference {
	var returns DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyleOutputReference
	_jsii_.Get(
		j,
		"style",
		&returns,
...
func (j *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) StyleInput() *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle {
...
func NewDashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference {
	...
	if err := validateNewDashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) PutNumberFormat(value *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaNumberFormat) {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) PutStyle(value *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle) {
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) ResetNumberFormat() {
	_jsii_.InvokeVoid(
		d,
		"resetNumberFormat",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) ResetStyle() {
	_jsii_.InvokeVoid(
		d,
		"resetStyle",
		nil, // no parameters
...
func (d *jsiiProxy_DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
