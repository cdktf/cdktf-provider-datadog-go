...
type DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormula struct {
	...
	Limit *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaLimit `field:"optional" json:"limit" yaml:"limit"`
	// number_format block.
	//
	...
	NumberFormat *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaNumberFormat `field:"optional" json:"numberFormat" yaml:"numberFormat"`
	// style block.
	//
	...
	Style *DashboardWidgetGroupDefinitionWidgetToplistDefinitionRequestFormulaStyle `field:"optional" json:"style" yaml:"style"`
}
