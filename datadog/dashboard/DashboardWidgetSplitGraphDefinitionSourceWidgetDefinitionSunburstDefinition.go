...
type DashboardWidgetSplitGraphDefinitionSourceWidgetDefinitionSunburstDefinition struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.61.0/docs/resources/dashboard#hide_total Dashboard#hide_total}
	HideTotal interface{} `field:"optional" json:"hideTotal" yaml:"hideTotal"`
	// legend_inline block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.61.0/docs/resources/dashboard#legend_inline Dashboard#legend_inline}
	...
	// legend_table block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.61.0/docs/resources/dashboard#legend_table Dashboard#legend_table}
