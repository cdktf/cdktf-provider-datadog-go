...
func (d *jsiiProxy_DashboardWidgetQueryTableDefinitionRequestConditionalFormatsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DashboardWidgetQueryTableDefinitionRequestConditionalFormatsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
