...
type DashboardWidgetGroupDefinitionWidgetSloListDefinitionRequest struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.56.0/docs/resources/dashboard#request_type Dashboard#request_type}
