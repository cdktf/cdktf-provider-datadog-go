...
type DashboardWidgetChangeDefinitionRequestQuery struct {
	...
	CloudCostQuery *DashboardWidgetChangeDefinitionRequestQueryCloudCostQuery `field:"optional" json:"cloudCostQuery" yaml:"cloudCostQuery"`
	// event_query block.
	//
	...
	SloQuery *DashboardWidgetChangeDefinitionRequestQuerySloQuery `field:"optional" json:"sloQuery" yaml:"sloQuery"`
}
