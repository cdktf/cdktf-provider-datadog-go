...
type DashboardWidgetScatterplotDefinitionRequestXRumQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardWidgetScatterplotDefinitionRequestXRumQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
