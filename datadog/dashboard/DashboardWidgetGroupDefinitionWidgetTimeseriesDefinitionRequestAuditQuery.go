...
type DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestAuditQuery struct {
	...
	ComputeQuery *DashboardWidgetGroupDefinitionWidgetTimeseriesDefinitionRequestAuditQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
