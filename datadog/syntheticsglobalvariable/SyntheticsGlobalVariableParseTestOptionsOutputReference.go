...
func (s *jsiiProxy_SyntheticsGlobalVariableParseTestOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SyntheticsGlobalVariableParseTestOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
