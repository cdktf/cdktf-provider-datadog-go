...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "isFido", GoGetter: "IsFido"},
			_jsii_.MemberProperty{JsiiProperty: "isFidoInput", GoGetter: "IsFidoInput"},
			_jsii_.MemberProperty{JsiiProperty: "isTotp", GoGetter: "IsTotp"},
			_jsii_.MemberProperty{JsiiProperty: "isTotpInput", GoGetter: "IsTotpInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "parseTestId", GoGetter: "ParseTestId"},
			_jsii_.MemberProperty{JsiiProperty: "parseTestIdInput", GoGetter: "ParseTestIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "parseTestOptions", GoGetter: "ParseTestOptions"},
			_jsii_.MemberProperty{JsiiProperty: "parseTestOptionsInput", GoGetter: "ParseTestOptionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putOptions", GoMethod: "PutOptions"},
			_jsii_.MemberMethod{JsiiMethod: "putParseTestOptions", GoMethod: "PutParseTestOptions"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIsFido", GoMethod: "ResetIsFido"},
			_jsii_.MemberMethod{JsiiMethod: "resetIsTotp", GoMethod: "ResetIsTotp"},
			_jsii_.MemberMethod{JsiiMethod: "resetOptions", GoMethod: "ResetOptions"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetParseTestId", GoMethod: "ResetParseTestId"},
			_jsii_.MemberMethod{JsiiMethod: "resetParseTestOptions", GoMethod: "ResetParseTestOptions"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putTotpParameters", GoMethod: "PutTotpParameters"},
			_jsii_.MemberMethod{JsiiMethod: "resetTotpParameters", GoMethod: "ResetTotpParameters"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "totpParameters", GoGetter: "TotpParameters"},
			_jsii_.MemberProperty{JsiiProperty: "totpParametersInput", GoGetter: "TotpParametersInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "localVariableName", GoGetter: "LocalVariableName"},
			_jsii_.MemberProperty{JsiiProperty: "localVariableNameInput", GoGetter: "LocalVariableNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLocalVariableName", GoMethod: "ResetLocalVariableName"},
			_jsii_.MemberMethod{JsiiMethod: "resetParser", GoMethod: "ResetParser"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
