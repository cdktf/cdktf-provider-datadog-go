...
// The jsii proxy struct for SecurityMonitoringRuleCaseList
type jsiiProxy_SecurityMonitoringRuleCaseList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_SecurityMonitoringRuleCaseList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SecurityMonitoringRuleCaseList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecurityMonitoringRuleCaseList) InternalValue() interface{} {
...
func (j *jsiiProxy_SecurityMonitoringRuleCaseList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SecurityMonitoringRuleCaseList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_SecurityMonitoringRuleCaseList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (s *jsiiProxy_SecurityMonitoringRuleCaseList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityMonitoringRuleCaseList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurityMonitoringRuleCaseList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SecurityMonitoringRuleCaseList) ToString() *string {
	var returns *string
