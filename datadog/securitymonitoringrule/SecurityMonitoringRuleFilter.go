...
type SecurityMonitoringRuleFilter struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.23.0/docs/resources/security_monitoring_rule#action SecurityMonitoringRule#action}
