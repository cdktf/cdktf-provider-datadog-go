...
func (s *jsiiProxy_SecurityMonitoringRuleReferenceTablesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecurityMonitoringRuleReferenceTablesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
