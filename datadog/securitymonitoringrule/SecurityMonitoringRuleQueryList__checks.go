...
func (s *jsiiProxy_SecurityMonitoringRuleQueryList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_SecurityMonitoringRuleQueryList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
