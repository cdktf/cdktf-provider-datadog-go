...
type DataDatadogServiceLevelObjectivesSlosList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) DataDatadogServiceLevelObjectivesSlosOutputReference
...
// The jsii proxy struct for DataDatadogServiceLevelObjectivesSlosList
type jsiiProxy_DataDatadogServiceLevelObjectivesSlosList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectivesSlosList) ToString() *string {
	var returns *string
