...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives) Count() interface{} {
...
func (j *jsiiProxy_DataDatadogServiceLevelObjectives)SetCount(val interface{}) {
...
func DataDatadogServiceLevelObjectives_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataDatadogServiceLevelObjectives_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataDatadogServiceLevelObjectives_IsTerraformDataSource(x interface{}) *bool {
	...
	if err := validateDataDatadogServiceLevelObjectives_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataDatadogServiceLevelObjectives_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateDataDatadogServiceLevelObjectives_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectives) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDatadogServiceLevelObjectives) ToHclTerraform() interface{} {
	var returns interface{}
