...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IntegrationMsTeamsTenantBasedHandle)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.integrationMsTeamsTenantBasedHandle.IntegrationMsTeamsTenantBasedHandleConfig",
		reflect.TypeOf((*IntegrationMsTeamsTenantBasedHandleConfig)(nil)).Elem(),
	)
}
