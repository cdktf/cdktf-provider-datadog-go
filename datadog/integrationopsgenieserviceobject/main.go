...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IntegrationOpsgenieServiceObject)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customUrl", GoGetter: "CustomUrl"},
			_jsii_.MemberProperty{JsiiProperty: "customUrlInput", GoGetter: "CustomUrlInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCustomUrl", GoMethod: "ResetCustomUrl"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IntegrationOpsgenieServiceObjectConfig)(nil)).Elem(),
	)
}
