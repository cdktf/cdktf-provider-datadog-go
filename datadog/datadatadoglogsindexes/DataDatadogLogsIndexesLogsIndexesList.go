...
func (d *jsiiProxy_DataDatadogLogsIndexesLogsIndexesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogLogsIndexesLogsIndexesList) Resolve(context cdktf.IResolveContext) interface{} {
