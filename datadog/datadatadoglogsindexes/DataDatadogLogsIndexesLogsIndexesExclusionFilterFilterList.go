...
func (d *jsiiProxy_DataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogLogsIndexesLogsIndexesExclusionFilterFilterList) Resolve(context cdktf.IResolveContext) interface{} {
