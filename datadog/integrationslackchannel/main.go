...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putDisplay", GoMethod: "PutDisplay"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "muteButtons", GoGetter: "MuteButtons"},
			_jsii_.MemberProperty{JsiiProperty: "muteButtonsInput", GoGetter: "MuteButtonsInput"},
			_jsii_.MemberProperty{JsiiProperty: "notified", GoGetter: "Notified"},
			_jsii_.MemberProperty{JsiiProperty: "notifiedInput", GoGetter: "NotifiedInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetMessage", GoMethod: "ResetMessage"},
			_jsii_.MemberMethod{JsiiMethod: "resetMuteButtons", GoMethod: "ResetMuteButtons"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotified", GoMethod: "ResetNotified"},
