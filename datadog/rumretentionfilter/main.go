...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RumRetentionFilter)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.rumRetentionFilter.RumRetentionFilterConfig",
		reflect.TypeOf((*RumRetentionFilterConfig)(nil)).Elem(),
	)
}
