...
type OrganizationSettingsSettingsSamlOutputReference interface {
	cdktf.ComplexObject
	...
	// Experimental.
	Fqn() *string
	InternalValue() *OrganizationSettingsSettingsSaml
	SetInternalValue(val *OrganizationSettingsSettingsSaml)
	// Experimental.
...
// The jsii proxy struct for OrganizationSettingsSettingsSamlOutputReference
type jsiiProxy_OrganizationSettingsSettingsSamlOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) InternalValue() *OrganizationSettingsSettingsSaml {
...
func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewOrganizationSettingsSettingsSamlOutputReference_Override(o OrganizationSettingsSettingsSamlOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (o *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) ComputeFqn() *string {
	var returns *string
...
func (o *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (o *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		o,
		"resetEnabled",
		nil, // no parameters
...
func (o *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (o *jsiiProxy_OrganizationSettingsSettingsSamlOutputReference) ToString() *string {
	var returns *string
