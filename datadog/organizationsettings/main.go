...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecurityContacts", GoMethod: "ResetSecurityContacts"},
			_jsii_.MemberMethod{JsiiMethod: "resetSettings", GoMethod: "ResetSettings"},
			_jsii_.MemberProperty{JsiiProperty: "securityContacts", GoGetter: "SecurityContacts"},
			_jsii_.MemberProperty{JsiiProperty: "securityContactsInput", GoGetter: "SecurityContactsInput"},
