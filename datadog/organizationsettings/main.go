...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "privateWidgetShare", GoGetter: "PrivateWidgetShare"},
			_jsii_.MemberProperty{JsiiProperty: "privateWidgetShareInput", GoGetter: "PrivateWidgetShareInput"},
			_jsii_.MemberMethod{JsiiMethod: "putSaml", GoMethod: "PutSaml"},
			_jsii_.MemberMethod{JsiiMethod: "putSamlAutocreateUsersDomains", GoMethod: "PutSamlAutocreateUsersDomains"},
			_jsii_.MemberMethod{JsiiMethod: "putSamlIdpInitiatedLogin", GoMethod: "PutSamlIdpInitiatedLogin"},
			_jsii_.MemberMethod{JsiiMethod: "putSamlStrictMode", GoMethod: "PutSamlStrictMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrivateWidgetShare", GoMethod: "ResetPrivateWidgetShare"},
			_jsii_.MemberMethod{JsiiMethod: "resetSamlAutocreateAccessRole", GoMethod: "ResetSamlAutocreateAccessRole"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "saml", GoGetter: "Saml"},
			_jsii_.MemberProperty{JsiiProperty: "samlAutocreateAccessRole", GoGetter: "SamlAutocreateAccessRole"},
			_jsii_.MemberProperty{JsiiProperty: "samlAutocreateAccessRoleInput", GoGetter: "SamlAutocreateAccessRoleInput"},
			_jsii_.MemberProperty{JsiiProperty: "samlAutocreateUsersDomains", GoGetter: "SamlAutocreateUsersDomains"},
			_jsii_.MemberProperty{JsiiProperty: "samlAutocreateUsersDomainsInput", GoGetter: "SamlAutocreateUsersDomainsInput"},
			_jsii_.MemberProperty{JsiiProperty: "samlCanBeEnabled", GoGetter: "SamlCanBeEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "samlIdpEndpoint", GoGetter: "SamlIdpEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "samlIdpInitiatedLogin", GoGetter: "SamlIdpInitiatedLogin"},
			_jsii_.MemberProperty{JsiiProperty: "samlIdpInitiatedLoginInput", GoGetter: "SamlIdpInitiatedLoginInput"},
			_jsii_.MemberProperty{JsiiProperty: "samlIdpMetadataUploaded", GoGetter: "SamlIdpMetadataUploaded"},
			_jsii_.MemberProperty{JsiiProperty: "samlInput", GoGetter: "SamlInput"},
			_jsii_.MemberProperty{JsiiProperty: "samlLoginUrl", GoGetter: "SamlLoginUrl"},
			_jsii_.MemberProperty{JsiiProperty: "samlStrictMode", GoGetter: "SamlStrictMode"},
			_jsii_.MemberProperty{JsiiProperty: "samlStrictModeInput", GoGetter: "SamlStrictModeInput"},
