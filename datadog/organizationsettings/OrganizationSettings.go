...
type OrganizationSettings interface {
	...
	PutSettings(value *OrganizationSettingsSettings)
	ResetId()
	ResetName()
...
func (j *jsiiProxy_OrganizationSettings) PublicId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicId",
...
func (j *jsiiProxy_OrganizationSettings) SettingsInput() *OrganizationSettingsSettings {
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.52.0/docs/resources/organization_settings datadog_organization_settings} Resource.
...
func (o *jsiiProxy_OrganizationSettings) PutSettings(value *OrganizationSettingsSettings) {
	if err := o.validatePutSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		o,
...
func (o *jsiiProxy_OrganizationSettings) ResetSettings() {
	_jsii_.InvokeVoid(
		o,
		"resetSettings",
		nil, // no parameters
