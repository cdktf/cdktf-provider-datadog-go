...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesOptionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesOptionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
