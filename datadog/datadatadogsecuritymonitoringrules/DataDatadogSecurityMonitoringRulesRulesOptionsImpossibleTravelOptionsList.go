...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesOptionsImpossibleTravelOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesOptionsImpossibleTravelOptionsList) Resolve(context cdktf.IResolveContext) interface{} {
