...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesQueryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRulesRulesQueryList) Resolve(context cdktf.IResolveContext) interface{} {
