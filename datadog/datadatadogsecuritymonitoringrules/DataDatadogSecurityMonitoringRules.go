...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules) Count() interface{} {
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.60.1/docs/data-sources/security_monitoring_rules datadog_security_monitoring_rules} Data Source.
func NewDataDatadogSecurityMonitoringRules(scope constructs.Construct, id *string, config *DataDatadogSecurityMonitoringRulesConfig) DataDatadogSecurityMonitoringRules {
	...
	if err := validateNewDataDatadogSecurityMonitoringRulesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules)SetDefaultOnlyFilter(val interface{}) {
	if err := j.validateSetDefaultOnlyFilterParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DataDatadogSecurityMonitoringRules)SetUserOnlyFilter(val interface{}) {
	if err := j.validateSetUserOnlyFilterParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DataDatadogSecurityMonitoringRules_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataDatadogSecurityMonitoringRules_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataDatadogSecurityMonitoringRules_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataDatadogSecurityMonitoringRules_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataDatadogSecurityMonitoringRules_IsTerraformDataSource(x interface{}) *bool {
	...
	if err := validateDataDatadogSecurityMonitoringRules_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataDatadogSecurityMonitoringRules_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateDataDatadogSecurityMonitoringRules_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRules) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringRules) ToHclTerraform() interface{} {
	var returns interface{}
