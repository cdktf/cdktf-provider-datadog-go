...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.56.0/docs/data-sources/team_memberships datadog_team_memberships} Data Source.
...
func (d *jsiiProxy_DataDatadogTeamMemberships) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDatadogTeamMemberships) ToHclTerraform() interface{} {
	var returns interface{}
