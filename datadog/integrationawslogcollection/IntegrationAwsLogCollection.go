...
package integrationawslogcollection
...
import (
	...
	"github.com/cdktf/cdktf-provider-datadog-go/datadog/v11/integrationawslogcollection/internal"
...
// The jsii proxy struct for IntegrationAwsLogCollection
type jsiiProxy_IntegrationAwsLogCollection struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_IntegrationAwsLogCollection) AccountId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountId",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) AccountIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"accountIdInput",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Connection() interface{} {
...
func (j *jsiiProxy_IntegrationAwsLogCollection) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Node() constructs.Node {
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) Services() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"services",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) ServicesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"servicesInput",
...
func (j *jsiiProxy_IntegrationAwsLogCollection) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IntegrationAwsLogCollection) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IntegrationAwsLogCollection) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IntegrationAwsLogCollection)SetCount(val interface{}) {
...
func IntegrationAwsLogCollection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIntegrationAwsLogCollection_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func IntegrationAwsLogCollection_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIntegrationAwsLogCollection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IntegrationAwsLogCollection_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIntegrationAwsLogCollection_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func IntegrationAwsLogCollection_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-datadog.integrationAwsLogCollection.IntegrationAwsLogCollection",
...
func (i *jsiiProxy_IntegrationAwsLogCollection) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IntegrationAwsLogCollection) ResetId() {
	_jsii_.InvokeVoid(
		i,
		"resetId",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationAwsLogCollection) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationAwsLogCollection) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IntegrationAwsLogCollection) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IntegrationAwsLogCollection) ToHclTerraform() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IntegrationAwsLogCollection) ToMetadata() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IntegrationAwsLogCollection) ToString() *string {
	var returns *string
...
func (i *jsiiProxy_IntegrationAwsLogCollection) ToTerraform() interface{} {
	var returns interface{}
