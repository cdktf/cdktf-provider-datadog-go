...
func (c *jsiiProxy_ChildOrganizationApplicationKeyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (c *jsiiProxy_ChildOrganizationApplicationKeyList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
