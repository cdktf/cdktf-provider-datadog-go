...
func (c *jsiiProxy_ChildOrganizationSettingsSamlAutocreateUsersDomainsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ChildOrganizationSettingsSamlAutocreateUsersDomainsList) Resolve(context cdktf.IResolveContext) interface{} {
