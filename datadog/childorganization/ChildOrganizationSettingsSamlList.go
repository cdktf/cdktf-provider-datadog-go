...
type ChildOrganizationSettingsSamlList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ChildOrganizationSettingsSamlOutputReference
...
// The jsii proxy struct for ChildOrganizationSettingsSamlList
type jsiiProxy_ChildOrganizationSettingsSamlList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ChildOrganizationSettingsSamlList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ChildOrganizationSettingsSamlList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ChildOrganizationSettingsSamlList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ChildOrganizationSettingsSamlList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ChildOrganizationSettingsSamlList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (c *jsiiProxy_ChildOrganizationSettingsSamlList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ChildOrganizationSettingsSamlList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ChildOrganizationSettingsSamlList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_ChildOrganizationSettingsSamlList) ToString() *string {
	var returns *string
