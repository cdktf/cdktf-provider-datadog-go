...
type ChildOrganizationUserList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ChildOrganizationUserOutputReference
...
// The jsii proxy struct for ChildOrganizationUserList
type jsiiProxy_ChildOrganizationUserList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ChildOrganizationUserList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ChildOrganizationUserList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ChildOrganizationUserList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ChildOrganizationUserList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ChildOrganizationUserList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (c *jsiiProxy_ChildOrganizationUserList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ChildOrganizationUserList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ChildOrganizationUserList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_ChildOrganizationUserList) ToString() *string {
	var returns *string
