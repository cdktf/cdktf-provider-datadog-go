...
func (j *jsiiProxy_ChildOrganization) ApiKey() ChildOrganizationApiKeyList {
	var returns ChildOrganizationApiKeyList
	_jsii_.Get(
		j,
		"apiKey",
		&returns,
...
func (j *jsiiProxy_ChildOrganization) ApplicationKey() ChildOrganizationApplicationKeyList {
	var returns ChildOrganizationApplicationKeyList
	_jsii_.Get(
		j,
		"applicationKey",
		&returns,
...
func (j *jsiiProxy_ChildOrganization) Connection() interface{} {
...
func (j *jsiiProxy_ChildOrganization) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_ChildOrganization) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ChildOrganization) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ChildOrganization) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ChildOrganization) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ChildOrganization) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ChildOrganization) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ChildOrganization) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ChildOrganization) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ChildOrganization) Node() constructs.Node {
...
func (j *jsiiProxy_ChildOrganization) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_ChildOrganization) PublicId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"publicId",
...
func (j *jsiiProxy_ChildOrganization) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_ChildOrganization) Settings() ChildOrganizationSettingsList {
	var returns ChildOrganizationSettingsList
	_jsii_.Get(
		j,
		"settings",
		&returns,
...
func (j *jsiiProxy_ChildOrganization) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ChildOrganization) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ChildOrganization) User() ChildOrganizationUserList {
	var returns ChildOrganizationUserList
	_jsii_.Get(
		j,
		"user",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.35.0/docs/resources/child_organization datadog_child_organization} Resource.
...
func ChildOrganization_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateChildOrganization_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ChildOrganization_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateChildOrganization_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ChildOrganization) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ChildOrganization) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ChildOrganization) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ChildOrganization) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ChildOrganization) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ChildOrganization) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ChildOrganization) ToMetadata() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_ChildOrganization) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_ChildOrganization) ToTerraform() interface{} {
	var returns interface{}
