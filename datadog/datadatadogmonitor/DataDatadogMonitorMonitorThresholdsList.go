...
type DataDatadogMonitorMonitorThresholdsList interface {
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) DataDatadogMonitorMonitorThresholdsOutputReference
...
// The jsii proxy struct for DataDatadogMonitorMonitorThresholdsList
type jsiiProxy_DataDatadogMonitorMonitorThresholdsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataDatadogMonitorMonitorThresholdsList) ToString() *string {
	var returns *string
