...
type DataDatadogMonitorMonitorThresholdWindowsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) DataDatadogMonitorMonitorThresholdWindowsOutputReference
...
// The jsii proxy struct for DataDatadogMonitorMonitorThresholdWindowsList
type jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataDatadogMonitorMonitorThresholdWindowsList) ToString() *string {
	var returns *string
