...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatadogServiceAccount)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "filterStatus", GoGetter: "FilterStatus"},
			_jsii_.MemberProperty{JsiiProperty: "filterStatusInput", GoGetter: "FilterStatusInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFilterStatus", GoMethod: "ResetFilterStatus"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.dataDatadogServiceAccount.DataDatadogServiceAccountConfig",
		reflect.TypeOf((*DataDatadogServiceAccountConfig)(nil)).Elem(),
	)
}
