...
func (j *jsiiProxy_DataDatadogIntegrationAwsLogsServices) Count() interface{} {
...
func (j *jsiiProxy_DataDatadogIntegrationAwsLogsServices)SetCount(val interface{}) {
...
func DataDatadogIntegrationAwsLogsServices_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataDatadogIntegrationAwsLogsServices_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataDatadogIntegrationAwsLogsServices) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataDatadogIntegrationAwsLogsServices) ToHclTerraform() interface{} {
	var returns interface{}
