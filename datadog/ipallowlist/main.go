...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IpAllowlist)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.ipAllowlist.IpAllowlistConfig",
		reflect.TypeOf((*IpAllowlistConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.ipAllowlist.IpAllowlistEntry",
		reflect.TypeOf((*IpAllowlistEntry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-datadog.ipAllowlist.IpAllowlistEntryList",
		reflect.TypeOf((*IpAllowlistEntryList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IpAllowlistEntryOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
