...
func (d *jsiiProxy_DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList) Resolve(context cdktf.IResolveContext) interface{} {
