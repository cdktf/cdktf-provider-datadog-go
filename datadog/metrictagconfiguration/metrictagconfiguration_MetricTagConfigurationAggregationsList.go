...
func (j *jsiiProxy_MetricTagConfigurationAggregationsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MetricTagConfigurationAggregationsList) InternalValue() interface{} {
...
func (j *jsiiProxy_MetricTagConfigurationAggregationsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_MetricTagConfigurationAggregationsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_MetricTagConfigurationAggregationsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_MetricTagConfigurationAggregationsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_MetricTagConfigurationAggregationsList)SetWrapsSet(val *bool) {
...
func (m *jsiiProxy_MetricTagConfigurationAggregationsList) ComputeFqn() *string {
	var returns *string
...
func (m *jsiiProxy_MetricTagConfigurationAggregationsList) Get(index *float64) MetricTagConfigurationAggregationsOutputReference {
	if err := m.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns MetricTagConfigurationAggregationsOutputReference
...
func (m *jsiiProxy_MetricTagConfigurationAggregationsList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (m *jsiiProxy_MetricTagConfigurationAggregationsList) ToString() *string {
	var returns *string
