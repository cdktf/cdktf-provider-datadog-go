...
func (m *jsiiProxy_MonitorVariablesEventQueryList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (m *jsiiProxy_MonitorVariablesEventQueryList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
