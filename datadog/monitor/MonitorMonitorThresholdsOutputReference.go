...
func (m *jsiiProxy_MonitorMonitorThresholdsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorMonitorThresholdsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
