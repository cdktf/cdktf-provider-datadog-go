...
type DowntimeRecurrence struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/downtime#type Downtime#type}
	Type *string `field:"required" json:"type" yaml:"type"`
	// How often to repeat as an integer.
	//
	// For example to repeat every 3 days, select a `type` of `days` and a `period` of `3`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/downtime#period Downtime#period}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/downtime#rrule Downtime#rrule}
	Rrule *string `field:"optional" json:"rrule" yaml:"rrule"`
	// The date at which the recurrence should end as a POSIX timestamp. `until_occurrences` and `until_date` are mutually exclusive.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/downtime#until_date Downtime#until_date}
	UntilDate *float64 `field:"optional" json:"untilDate" yaml:"untilDate"`
	// How many times the downtime will be rescheduled. `until_occurrences` and `until_date` are mutually exclusive.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/downtime#until_occurrences Downtime#until_occurrences}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/downtime#week_days Downtime#week_days}
