...
func (l *jsiiProxy_LogsCustomDestinationHttpDestinationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogsCustomDestinationHttpDestinationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
