...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "accountFiltersInput", GoGetter: "AccountFiltersInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAccountFilters", GoMethod: "PutAccountFilters"},
			...
			_jsii_.MemberProperty{JsiiProperty: "reportPrefix", GoGetter: "ReportPrefix"},
			_jsii_.MemberProperty{JsiiProperty: "reportPrefixInput", GoGetter: "ReportPrefixInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAccountFilters", GoMethod: "ResetAccountFilters"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "includedAccounts", GoGetter: "IncludedAccounts"},
			_jsii_.MemberProperty{JsiiProperty: "includedAccountsInput", GoGetter: "IncludedAccountsInput"},
			_jsii_.MemberProperty{JsiiProperty: "includeNewAccounts", GoGetter: "IncludeNewAccounts"},
			_jsii_.MemberProperty{JsiiProperty: "includeNewAccountsInput", GoGetter: "IncludeNewAccountsInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetExcludedAccounts", GoMethod: "ResetExcludedAccounts"},
			_jsii_.MemberMethod{JsiiMethod: "resetIncludedAccounts", GoMethod: "ResetIncludedAccounts"},
			_jsii_.MemberMethod{JsiiMethod: "resetIncludeNewAccounts", GoMethod: "ResetIncludeNewAccounts"},
