...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultPermissionsOptOut", GoGetter: "DefaultPermissionsOptOut"},
			_jsii_.MemberProperty{JsiiProperty: "defaultPermissionsOptOutInput", GoGetter: "DefaultPermissionsOptOutInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultPermissionsOptOut", GoMethod: "ResetDefaultPermissionsOptOut"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*RolePermission)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-datadog.role.RolePermissionList",
		reflect.TypeOf((*RolePermissionList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RolePermissionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
