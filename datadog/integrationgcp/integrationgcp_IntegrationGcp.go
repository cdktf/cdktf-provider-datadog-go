...
import (
	...
	"github.com/hashicorp/cdktf-provider-datadog-go/datadog/v3/integrationgcp/internal"
...
func (j *jsiiProxy_IntegrationGcp) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IntegrationGcp)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
