...
func (i *jsiiProxy_IntegrationGcpMonitoredResourceConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IntegrationGcpMonitoredResourceConfigsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
