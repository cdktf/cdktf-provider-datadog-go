...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IntegrationCloudflareAccount)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.integrationCloudflareAccount.IntegrationCloudflareAccountConfig",
		reflect.TypeOf((*IntegrationCloudflareAccountConfig)(nil)).Elem(),
	)
}
