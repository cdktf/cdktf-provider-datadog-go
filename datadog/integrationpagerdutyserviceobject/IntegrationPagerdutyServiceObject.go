...
import (
	...
	"github.com/cdktf/cdktf-provider-datadog-go/datadog/v12/integrationpagerdutyserviceobject/internal"
...
func (j *jsiiProxy_IntegrationPagerdutyServiceObject) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.73.0/docs/resources/integration_pagerduty_service_object datadog_integration_pagerduty_service_object} Resource.
func NewIntegrationPagerdutyServiceObject(scope constructs.Construct, id *string, config *IntegrationPagerdutyServiceObjectConfig) IntegrationPagerdutyServiceObject {
	...
	if err := validateNewIntegrationPagerdutyServiceObjectParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IntegrationPagerdutyServiceObject)SetCount(val interface{}) {
...
func IntegrationPagerdutyServiceObject_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIntegrationPagerdutyServiceObject_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IntegrationPagerdutyServiceObject_IsConstruct(x interface{}) *bool {
	...
	if err := validateIntegrationPagerdutyServiceObject_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IntegrationPagerdutyServiceObject_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIntegrationPagerdutyServiceObject_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IntegrationPagerdutyServiceObject_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIntegrationPagerdutyServiceObject_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IntegrationPagerdutyServiceObject) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IntegrationPagerdutyServiceObject) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IntegrationPagerdutyServiceObject) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IntegrationPagerdutyServiceObject) MoveFromId(id *string) {
...
func (i *jsiiProxy_IntegrationPagerdutyServiceObject) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IntegrationPagerdutyServiceObject) MoveToId(id *string) {
...
func (i *jsiiProxy_IntegrationPagerdutyServiceObject) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IntegrationPagerdutyServiceObject) ToHclTerraform() interface{} {
	var returns interface{}
