...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IncidentNotificationTemplate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.incidentNotificationTemplate.IncidentNotificationTemplateConfig",
		reflect.TypeOf((*IncidentNotificationTemplateConfig)(nil)).Elem(),
	)
}
