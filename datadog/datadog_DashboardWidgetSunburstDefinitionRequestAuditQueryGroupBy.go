...
type DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBy struct {
	// The facet name.
	//
	...
	SortQuery *DashboardWidgetSunburstDefinitionRequestAuditQueryGroupBySortQuery `field:"optional" json:"sortQuery" yaml:"sortQuery"`
}
