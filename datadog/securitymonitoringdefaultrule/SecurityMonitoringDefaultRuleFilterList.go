...
type SecurityMonitoringDefaultRuleFilterList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) SecurityMonitoringDefaultRuleFilterOutputReference
...
// The jsii proxy struct for SecurityMonitoringDefaultRuleFilterList
type jsiiProxy_SecurityMonitoringDefaultRuleFilterList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) InternalValue() interface{} {
...
func (j *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (s *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_SecurityMonitoringDefaultRuleFilterList) ToString() *string {
	var returns *string
