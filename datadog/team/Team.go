...
import (
	...
	"github.com/cdktf/cdktf-provider-datadog-go/datadog/v12/team/internal"
...
func (j *jsiiProxy_Team) Handle() *string {
	var returns *string
	_jsii_.Get(
		j,
		"handle",
...
func (j *jsiiProxy_Team) HandleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"handleInput",
...
func (j *jsiiProxy_Team) LinkCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"linkCount",
...
func (j *jsiiProxy_Team) Summary() *string {
	var returns *string
	_jsii_.Get(
		j,
		"summary",
...
func (j *jsiiProxy_Team) UserCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"userCount",
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.69.0/docs/resources/team datadog_team} Resource.
func NewTeam(scope constructs.Construct, id *string, config *TeamConfig) Team {
	...
	_jsii_.Create(
		"@cdktf/provider-datadog.team.Team",
...
func (j *jsiiProxy_Team)SetHandle(val *string) {
