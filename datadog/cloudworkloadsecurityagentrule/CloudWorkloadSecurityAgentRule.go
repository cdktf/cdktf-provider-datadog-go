...
import (
	...
	"github.com/cdktf/cdktf-provider-datadog-go/datadog/v11/cloudworkloadsecurityagentrule/internal"
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Connection() interface{} {
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Expression() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expression",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) ExpressionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expressionInput",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Node() constructs.Node {
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule)SetCount(val interface{}) {
...
// Experimental.
func CloudWorkloadSecurityAgentRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudWorkloadSecurityAgentRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func CloudWorkloadSecurityAgentRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateCloudWorkloadSecurityAgentRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func CloudWorkloadSecurityAgentRule_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-datadog.cloudWorkloadSecurityAgentRule.CloudWorkloadSecurityAgentRule",
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) ResetDescription() {
	_jsii_.InvokeVoid(
		c,
		"resetDescription",
		nil, // no parameters
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) ResetEnabled() {
	_jsii_.InvokeVoid(
		c,
		"resetEnabled",
		nil, // no parameters
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) ToHclTerraform() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) ToMetadata() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_CloudWorkloadSecurityAgentRule) ToTerraform() interface{} {
	var returns interface{}
