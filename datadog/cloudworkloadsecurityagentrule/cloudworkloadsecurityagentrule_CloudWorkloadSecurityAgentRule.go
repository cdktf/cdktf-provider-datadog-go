...
import (
	...
	"github.com/cdktf/cdktf-provider-datadog-go/datadog/v5/cloudworkloadsecurityagentrule/internal"
...
func (j *jsiiProxy_CloudWorkloadSecurityAgentRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
