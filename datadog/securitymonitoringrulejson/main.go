...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecurityMonitoringRuleJson)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.securityMonitoringRuleJson.SecurityMonitoringRuleJsonConfig",
		reflect.TypeOf((*SecurityMonitoringRuleJsonConfig)(nil)).Elem(),
	)
}
