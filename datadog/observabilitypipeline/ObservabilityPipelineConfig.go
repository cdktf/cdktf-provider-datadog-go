...
type ObservabilityPipelineConfig struct {
	...
	// config block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.67.0/docs/resources/observability_pipeline#config ObservabilityPipeline#config}
