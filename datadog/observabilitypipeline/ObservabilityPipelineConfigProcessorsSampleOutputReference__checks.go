...
func (o *jsiiProxy_ObservabilityPipelineConfigProcessorsSampleOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (o *jsiiProxy_ObservabilityPipelineConfigProcessorsSampleOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
