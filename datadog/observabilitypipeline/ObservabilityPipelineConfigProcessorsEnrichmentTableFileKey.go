...
type ObservabilityPipelineConfigProcessorsEnrichmentTableFileKey struct {
	// The `items` `column`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.63.0/docs/resources/observability_pipeline#column ObservabilityPipeline#column}
	Column *string `field:"optional" json:"column" yaml:"column"`
	// The comparison method (e.g. equals).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.63.0/docs/resources/observability_pipeline#comparison ObservabilityPipeline#comparison}
