...
type ObservabilityPipelineConfigProcessorsGenerateDatadogMetrics struct {
	...
	// metrics block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.68.0/docs/resources/observability_pipeline#metrics ObservabilityPipeline#metrics}
