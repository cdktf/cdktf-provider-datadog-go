...
type ObservabilityPipelineConfigProcessorsSample struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.68.0/docs/resources/observability_pipeline#percentage ObservabilityPipeline#percentage}
	Percentage *float64 `field:"optional" json:"percentage" yaml:"percentage"`
	// Number of events to sample (1 in N).
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.68.0/docs/resources/observability_pipeline#rate ObservabilityPipeline#rate}
