...
type ObservabilityPipelineConfigProcessorsThrottle struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.63.0/docs/resources/observability_pipeline#threshold ObservabilityPipeline#threshold}
	Threshold *float64 `field:"required" json:"threshold" yaml:"threshold"`
	// The time window in seconds over which the threshold applies.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.63.0/docs/resources/observability_pipeline#window ObservabilityPipeline#window}
