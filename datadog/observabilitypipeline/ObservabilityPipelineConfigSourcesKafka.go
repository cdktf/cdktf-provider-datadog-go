...
type ObservabilityPipelineConfigSourcesKafka struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.67.0/docs/resources/observability_pipeline#group_id ObservabilityPipeline#group_id}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.67.0/docs/resources/observability_pipeline#topics ObservabilityPipeline#topics}
	Topics *[]*string `field:"required" json:"topics" yaml:"topics"`
	// librdkafka_option block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.67.0/docs/resources/observability_pipeline#librdkafka_option ObservabilityPipeline#librdkafka_option}
	LibrdkafkaOption interface{} `field:"optional" json:"librdkafkaOption" yaml:"librdkafkaOption"`
	// sasl block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.67.0/docs/resources/observability_pipeline#sasl ObservabilityPipeline#sasl}
