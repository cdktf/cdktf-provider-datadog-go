...
func (l *jsiiProxy_LogsMetricGroupByList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (l *jsiiProxy_LogsMetricGroupByList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
