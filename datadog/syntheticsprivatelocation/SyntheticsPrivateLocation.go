...
type SyntheticsPrivateLocation interface {
	...
	RestrictionPolicyResourceId() *string
	Tags() *[]*string
	SetTags(val *[]*string)
	TagsInput() *[]*string
	// Experimental.
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Config() *string {
	var returns *string
	_jsii_.Get(
		j,
		"config",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Connection() interface{} {
...
func (j *jsiiProxy_SyntheticsPrivateLocation) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Node() constructs.Node {
...
func (j *jsiiProxy_SyntheticsPrivateLocation) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) RestrictionPolicyResourceId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"restrictionPolicyResourceId",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_SyntheticsPrivateLocation) Tags() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) TagsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_SyntheticsPrivateLocation) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SyntheticsPrivateLocation) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.76.0/docs/resources/synthetics_private_location datadog_synthetics_private_location} Resource.
...
func (j *jsiiProxy_SyntheticsPrivateLocation)SetCount(val interface{}) {
...
// Experimental.
func SyntheticsPrivateLocation_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSyntheticsPrivateLocation_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SyntheticsPrivateLocation_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSyntheticsPrivateLocation_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SyntheticsPrivateLocation_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-datadog.syntheticsPrivateLocation.SyntheticsPrivateLocation",
...
func (s *jsiiProxy_SyntheticsPrivateLocation) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsPrivateLocation) MoveFromId(id *string) {
...
func (s *jsiiProxy_SyntheticsPrivateLocation) MoveToId(id *string) {
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ResetDescription() {
	_jsii_.InvokeVoid(
		s,
		"resetDescription",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ResetMetadata() {
	_jsii_.InvokeVoid(
		s,
		"resetMetadata",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ResetTags() {
	_jsii_.InvokeVoid(
		s,
		"resetTags",
		nil, // no parameters
...
func (s *jsiiProxy_SyntheticsPrivateLocation) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SyntheticsPrivateLocation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ToHclTerraform() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ToMetadata() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ToString() *string {
	var returns *string
...
func (s *jsiiProxy_SyntheticsPrivateLocation) ToTerraform() interface{} {
	var returns interface{}
