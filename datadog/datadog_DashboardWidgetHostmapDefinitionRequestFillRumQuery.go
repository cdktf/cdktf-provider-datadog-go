...
type DashboardWidgetHostmapDefinitionRequestFillRumQuery struct {
	...
	ComputeQuery *DashboardWidgetHostmapDefinitionRequestFillRumQueryComputeQuery `field:"optional" json:"computeQuery" yaml:"computeQuery"`
	// group_by block.
	//
