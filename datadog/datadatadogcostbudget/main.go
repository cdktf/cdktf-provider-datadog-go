...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.dataDatadogCostBudget.DataDatadogCostBudgetConfig",
		reflect.TypeOf((*DataDatadogCostBudgetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.dataDatadogCostBudget.DataDatadogCostBudgetEntries",
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-datadog.dataDatadogCostBudget.DataDatadogCostBudgetEntriesTagFilters",
