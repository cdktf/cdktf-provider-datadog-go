...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putUniqueness", GoMethod: "PutUniqueness"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUniqueness", GoMethod: "ResetUniqueness"},
			...
			_jsii_.MemberProperty{JsiiProperty: "uniqueness", GoGetter: "Uniqueness"},
			_jsii_.MemberProperty{JsiiProperty: "uniquenessInput", GoGetter: "UniquenessInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIncludePercentiles", GoMethod: "ResetIncludePercentiles"},
