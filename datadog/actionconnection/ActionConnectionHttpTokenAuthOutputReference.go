...
func (a *jsiiProxy_ActionConnectionHttpTokenAuthOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ActionConnectionHttpTokenAuthOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
