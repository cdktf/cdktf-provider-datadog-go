...
func (j *jsiiProxy_ActionConnection) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ActionConnection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ActionConnection) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ActionConnection) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ActionConnection) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ActionConnection)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ActionConnection)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ActionConnection)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ActionConnection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ActionConnection) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ActionConnection) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ActionConnection) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
