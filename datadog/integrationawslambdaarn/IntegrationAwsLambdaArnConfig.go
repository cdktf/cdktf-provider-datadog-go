...
type IntegrationAwsLambdaArnConfig struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.28.0/docs/resources/integration_aws_lambda_arn#id IntegrationAwsLambdaArn#id}.
	//
