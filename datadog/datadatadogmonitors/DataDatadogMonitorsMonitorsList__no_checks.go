...
func (d *jsiiProxy_DataDatadogMonitorsMonitorsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataDatadogMonitorsMonitorsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
