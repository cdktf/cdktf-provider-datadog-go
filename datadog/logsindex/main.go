...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "flexRetentionDaysInput", GoGetter: "FlexRetentionDaysInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFlexRetentionDays", GoMethod: "ResetFlexRetentionDays"},
