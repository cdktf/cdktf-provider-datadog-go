...
type LogsIndexExclusionFilterOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for LogsIndexExclusionFilterOutputReference
type jsiiProxy_LogsIndexExclusionFilterOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) Filter() LogsIndexExclusionFilterFilterList {
	var returns LogsIndexExclusionFilterFilterList
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) FilterInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) IsEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isEnabled",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) IsEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isEnabledInput",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LogsIndexExclusionFilterOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (l *jsiiProxy_LogsIndexExclusionFilterOutputReference) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LogsIndexExclusionFilterOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (l *jsiiProxy_LogsIndexExclusionFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogsIndexExclusionFilterOutputReference) ResetFilter() {
	_jsii_.InvokeVoid(
		l,
		"resetFilter",
		nil, // no parameters
...
func (l *jsiiProxy_LogsIndexExclusionFilterOutputReference) ResetIsEnabled() {
	_jsii_.InvokeVoid(
		l,
		"resetIsEnabled",
		nil, // no parameters
...
func (l *jsiiProxy_LogsIndexExclusionFilterOutputReference) ResetName() {
	_jsii_.InvokeVoid(
		l,
		"resetName",
		nil, // no parameters
...
func (l *jsiiProxy_LogsIndexExclusionFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (l *jsiiProxy_LogsIndexExclusionFilterOutputReference) ToString() *string {
	var returns *string
