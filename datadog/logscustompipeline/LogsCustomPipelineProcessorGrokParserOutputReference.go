...
func (l *jsiiProxy_LogsCustomPipelineProcessorGrokParserOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorGrokParserOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
