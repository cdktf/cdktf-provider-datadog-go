...
func (l *jsiiProxy_LogsCustomPipelineProcessorUserAgentParserOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorUserAgentParserOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
