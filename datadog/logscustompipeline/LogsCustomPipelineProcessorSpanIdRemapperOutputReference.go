...
func (l *jsiiProxy_LogsCustomPipelineProcessorSpanIdRemapperOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorSpanIdRemapperOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
