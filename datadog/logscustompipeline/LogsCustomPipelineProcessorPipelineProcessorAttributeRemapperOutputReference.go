...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorAttributeRemapperOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorPipelineProcessorAttributeRemapperOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
