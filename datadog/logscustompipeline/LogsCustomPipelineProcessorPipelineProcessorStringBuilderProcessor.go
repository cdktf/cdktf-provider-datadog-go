...
type LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessor struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.41.0/docs/resources/logs_custom_pipeline#template LogsCustomPipeline#template}
