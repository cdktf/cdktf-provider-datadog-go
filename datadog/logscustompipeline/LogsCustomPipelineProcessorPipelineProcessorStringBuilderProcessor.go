...
type LogsCustomPipelineProcessorPipelineProcessorStringBuilderProcessor struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.44.0/docs/resources/logs_custom_pipeline#template LogsCustomPipeline#template}
