...
type LogsCustomPipelineProcessorPipelineProcessorLookupProcessor struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.43.1/docs/resources/logs_custom_pipeline#lookup_table LogsCustomPipeline#lookup_table}
	LookupTable *[]*string `field:"required" json:"lookupTable" yaml:"lookupTable"`
	// Name of the source attribute used to do the lookup.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.43.1/docs/resources/logs_custom_pipeline#source LogsCustomPipeline#source}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.43.1/docs/resources/logs_custom_pipeline#default_lookup LogsCustomPipeline#default_lookup}
