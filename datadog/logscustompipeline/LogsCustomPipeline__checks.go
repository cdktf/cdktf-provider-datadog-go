...
func (l *jsiiProxy_LogsCustomPipeline) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (l *jsiiProxy_LogsCustomPipeline) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (l *jsiiProxy_LogsCustomPipeline) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (l *jsiiProxy_LogsCustomPipeline) validateMoveToParameters(moveTarget *string, index interface{}) error {
	if moveTarget == nil {
		return fmt.Errorf("parameter moveTarget is required, but nil was provided")
	}
...
func (l *jsiiProxy_LogsCustomPipeline) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (l *jsiiProxy_LogsCustomPipeline) validatePutFilterParameters(value interface{}) error {
	...
	case *[]*LogsCustomPipelineFilter:
		value := value.(*[]*LogsCustomPipelineFilter)
	...
	case []*LogsCustomPipelineFilter:
		value_ := value.([]*LogsCustomPipelineFilter)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*LogsCustomPipelineFilter; received %#v (a %T)", value, value)
		}
	}
...
func (l *jsiiProxy_LogsCustomPipeline) validatePutProcessorParameters(value interface{}) error {
	...
	case *[]*LogsCustomPipelineProcessor:
		value := value.(*[]*LogsCustomPipelineProcessor)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*LogsCustomPipelineProcessor:
		value_ := value.([]*LogsCustomPipelineProcessor)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*LogsCustomPipelineProcessor; received %#v (a %T)", value, value)
		}
	}
...
func validateLogsCustomPipeline_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
...
func validateLogsCustomPipeline_IsTerraformElementParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateLogsCustomPipeline_IsTerraformResourceParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func (j *jsiiProxy_LogsCustomPipeline) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
