...
func (j *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList) InternalValue() interface{} {
...
func (j *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList)SetWrapsSet(val *bool) {
...
func (l *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList) ComputeFqn() *string {
	var returns *string
...
func (l *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList) Get(index *float64) LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperOutputReference {
	if err := l.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperOutputReference
...
func (l *jsiiProxy_LogsCustomPipelineProcessorSchemaProcessorMappersSchemaCategoryMapperList) ToString() *string {
	var returns *string
