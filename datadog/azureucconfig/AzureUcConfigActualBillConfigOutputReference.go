...
func (a *jsiiProxy_AzureUcConfigActualBillConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AzureUcConfigActualBillConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
